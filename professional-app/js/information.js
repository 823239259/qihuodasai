...
/*下拉刷新 上拉加载*/
	...
	function financeList(fund) {
		...
		var time = tzdr.dateUtil.getFormatDataByLong(fund.timestamp,"hh:mm");
        ...
        var country;
        if(fund.country == "中国"){
        	country ="<img src='../../images/China.png'/>";
        }else if(fund.country == "英国") {
        	country ="<img src='../../images/Britain.png'/>";
        }else if(fund.country == "意大利") {
        	country ="<img src='../../images/Italy.png'/>";
        }else if(fund.country == "新西兰") {
        	country ="<img src='../../images/Zealand.png'/>";
        }else if(fund.country == "西班牙") {
        	country ="<img src='../../images/Spain.png'/>";
        }else if(fund.country == "瑞士") {
        	country ="<img src='../../images/Switzerland.png'/>";
        }else if(fund.country == "瑞典") {
        	country ="<img src='../../images/Sweden.png'/>";
        }else if(fund.country == "日本") {
        	country ="<img src='../../images/Japan.png'/>";
        }else if(fund.country == "欧元区") {
        	country ="<img src='../../images/Eurozone.png'/>";
        }else if(fund.country == "美国") {
        	country ="<img src='../../images/USA.png'/>";
        }else if(fund.country == "加拿大") {
        	country ="<img src='../../images/Canada.png'/>";
        }else if(fund.country == "韩国") {
        	country ="<img src='../../images/Seoul.png'/>";
        }else if(fund.country == "法国") {
        	country ="<img src='../../images/France.png'/>";
        }else if(fund.country == "俄罗斯") {
        	country ="<img src='../../images/Russia.png'/>";
        }else if(fund.country == "德国") {
        	country ="<img src='../../images/Germany.png'/>";
        }else if(fund.country == "朝鲜") {
        	country ="<img src='../../images/NorthKorea.png'/>";
        }else if(fund.country == "比利时") {
        	country ="<img src='../../images/Belgium.png'/>";
        ...
        if(fund.previous==null){
	  	...
	  	li.innerHTML =  "<div class='mui-col-xs-3 mui-col-sm-3 finance-left "+importance+" '>"+
						...
						"<img src='../../images/directSeed-clock.png'/></div>"+
