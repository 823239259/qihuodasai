 ...
 * https://gist.github.com/razor1895/2e755135af960752c164fad62f169ec9
 */
...
import { Colors, Variables, Layout } from '../global';
...
export default class IndicatorPullToRefresh extends Component {
  static propTypes = {
    ...
    if (this.props.refreshing && (scrollStatus === 'EXCEEDED_MIN_PULL_DOWN_DISTANCE' || scrollStatus === 'EXCEEDED_MIN_PULL_UP_DISTANCE')) {
      ...
      indicator = (
        <Animated.Image
          ...
          resizeMode={'cover'}
          source={Variables.icon.indicatorArrowUp.source}
        />
      );
    } else {
      indicator = (
        <Animated.Image
          ...
          resizeMode={'cover'}
          source={Variables.icon.indicatorArrowDown.source}
        />
      );
    }
