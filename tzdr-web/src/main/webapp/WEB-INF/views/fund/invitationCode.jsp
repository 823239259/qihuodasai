...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/script/homepage/d3.min.js"></script>
	<script type="text/javascript" src="${ctx}/static/script/homepage/react.min.js"></script>
	...
	<script type="text/javascript" src="${ctx}/static/script/homepage/jquery-2.1.4.min.js"></script>
	...
	.div_loading {width: 285px;height: 100%;text-align: left;z-index: 10000;margin: 0 auto;}
        ...
        .dropdown-menu{position:absolute;z-index:1000;display:none; border-radius: 4px;}
        .dropdown-menu>li>a{display:block;white-space:nowrap}
        .open>.dropdown-menu{display:block;background: #1a1a1a;}
        .dropdown-header{display:none;}
        .indicators {display: none;}
        
        .btn{
        	display: inline-block;height: 34px; width: 100px;margin-bottom: 0; font-size: 14px;font-weight: 400;line-height: 1.42857143;text-align: center;
        ...
        .btn-default {color: #eee; background-color: #1a1a1a; border-color: #1a1a1a;}
        .open>.dropdown-menu li {list-style-type: none; width: 88px; height: 30px; line-height: 30px; padding-left: 10px;}
        .open>.dropdown-menu li:hover {background-color: #292929;border-radius: 4px;}
        .open>.dropdown-menu li a {color: #eee; text-decoration: none;}
		/* 行情CSS结束 */
	</style>
	<script type="text/javascript">
            ...
            <div class="right_xiangqing">
                <div id="main" style="height:500px; width: 800px;">
                	<div style="position: relative;">
		    			<div class="carbon" style="position: absolute">
					        <div id="app">
...
<script type="text/javascript" src="${ctx }/static/script/homepage/bundle.min.js"></script>
<script type="text/javascript">
