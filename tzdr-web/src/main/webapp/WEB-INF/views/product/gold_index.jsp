	...
	<input type="hidden" id="input_tranFees" name ="inputTranFees" value="${tranFeesArray[0]}" >
		<div class="capital">			
		    <div class="mc_nav">
		        ...
		        <a href="${ctx}/product/gold_index" class="on">沪金期货</a>
			...
			<div class="capital_ctn">
				...
				<div class="cp_sider sif_sider">
					<h2>确认操盘规则</h2>
					<div class="cp_sdfont">
						<label>操盘须知：</label> <span style="color:#ff6500; font-size:16px;">投资沪金当期主力合约（${contract}）</span>
					</div>
					<div class="cp_sdfont">
				...
				<div class="cp_bom">
					...
					<div class="cp_b_btn">
						<a href="javascript:void();" onclick="submitSetting(1)">提交操盘申请</a>
					</div>
				</div>
			</div>
		    ...
		    <div class="capital_rule">
		        ...
		        <h2>沪金期货介绍</h2>
		        <p>沪金期货，是上海期货交易所黄金期货的简称。有做空机制，可双向交易获利，涨跌行情中均有获利机会。T+0交易制度。当天可以多次开仓平仓，但有交割日，到期必须交割，否则会被强行平仓或以实物进行交割。投资成本小，市场流动性高；同时还为投资者提供了卖空机制，为投资者提供了一个交易平台，较宜适合投资理财。</p>	
		        <h2>交易细则</h2>        
		        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cp_ru_list">
		          ...
		          <tr>
		            ...
		            <td class="font">上海期货交易所黄金主力合约，交易代码AUM</td>
		          </tr>
		          <tr>
		            <td class="first">最小波动价</td>
		            <td class="font">0.05个指数点（50元）</td>
		          </tr>
		          <tr>
		            <td class="first">合约乘数</td>
		            <td class="font">1000元/点</td>
		          </tr>
		          <tr>
		          ...
		          <tr>
		            ...
		            <td class="font">看多时：交易盈亏=（卖出价-买入价）* 1000<br>看空时：交易盈亏=（买入价-卖出价）* 1000</td>
		          </tr>		          
		          <tr>
