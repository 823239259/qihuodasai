			...
			<div class="cp_ctn">
				...
				<div class="cp_payctn">	
					...
					<div class="cp_paybtn">
						...
						<div class="cp_btnback"><a href="${ctx}/product/gold_index">返回修改</a></div>
					</div>
				</div>
				<%--<div class="cp_paymoney" style="display:none;">--%>
					<%--<!-- 账户余额充足的时候，span隐藏 -->--%>
					<%--&lt;%&ndash;<c:if test="${showAvl == 1}">&ndash;%&gt;--%>
					<%--&lt;%&ndash;<span>您的账户余额只剩<i>${avlBal_user}</i>元，本次支付还差<i>${payable_avlBal_user}</i>元。<a href="${ctx}/pay/payinfo">立即充值</a></span>&ndash;%&gt;--%>
					<%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
				<%--</div>--%>
			</div>
		</form>
