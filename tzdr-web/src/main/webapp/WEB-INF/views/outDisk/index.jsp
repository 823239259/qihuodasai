        ...
        <div class="cpx_main">
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="cpx_ru_list">
                ...
                <tr>
                    ...
                    <td>只交易小恒指时，初始最大可持仓<i id='nikkeiTranActualLever'>${outDiskParameters[0].nikkeiTranActualLever}</i>手</td>
                ...
                <tr>
                    ...
                    <td>06:05-04:55</td>
                    <td>只交易美黄金时，初始最大可持仓<i id='nikkeiTranActualLever'>${outDiskParameters[0].nikkeiTranActualLever}</i>手</td>
