...
<style type="text/css">
.ul_td_rulefont li span a { color:#0aaff4;}
.ul_td_rulefont li span a:hover { text-decoration:underline; }
</style>
</head>
<body>
...
<div class="floatlayer">
	...
	<div class="fl_box fl_uc_trade sif_money_div" id="applyHKEndTrade" name="applyHKEndTrade" style="display:none;" >
		...
		<div class="fl_uc_main">						
			<p style="font-size:14px;text-align: center;font-family: '微软雅黑'; margin-top:10px;">工作日17:30前的终结申请，当日结算；工作日17:30后的终结申请，下个工作日17:30前结算。</p>
			...
			<div class="uc_td_rule">
				...
				<ul class="ul_td_rulelist">
					...
					<ol class="ul_td_rulefont">
						<li>
							<label>操盘须知</label>
							<span>${operatorsInfo}<a href="${ctx}/help?tab=configuration&leftMenu=10" target="_blank">港股黑名单>></a></span>
						</li>
					</ol>
				</ul>	
			</div>
			...
			<div class="uc_td_interest box box4">
				<c:if test="${trade.status ne 0}">			
					<div class="uc_tlpromt_account">					
						...
						<p> 交易软件：<a href="${ctx}/help?tab=software&leftMenu=1" target='_blank'>请点击这里按照说明安装交易软件</a></p>
					</div>
				</c:if>	
			</div>
		</div>
