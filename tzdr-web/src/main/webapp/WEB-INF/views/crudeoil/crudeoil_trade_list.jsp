...
<script type="text/javascript" src="${ctx}/static/script/crudeoil/crudeoilList.js?v=${v}"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
		...
		$("#nav_my").addClass("on");
	    $("#crudeoil").parent().addClass("on");
	    $.easyui.rechangeSetValue(".tzdr-tab",null,function(tag){
	    	$("#appStateCrudeOilPage").html("");
	    	$(".tzdr-data01").hide();
	    	var tabId = $(tag).attr("id");
	    	var id = tabId + "Data";
	    	var type = "";
	    	if(id == "appStateCrudeOilData"){  //国际原油
	    		type = "6";
	    		getCrudeOilDataList(page_index,type,
			    		tabId,"appStateCrudeOilPage","pay");
	    	}
	    	$("#" + id).show();
	    },null);
	    
    	$("#appStateCrudeOil").trigger("click");
    });
...
<body>
	...
	<!-- 国际原油账单明细 -->
	<div class="sif_money sif_money_div ftse_money" id="detailInfoCrudeOil" style="display:none;">
		<div class="fl_navtitle">
			<h3>账单明细</h3>
			<a href="javascript:void(0);" onclick="closeWindow('#detailInfoCrudeOil')" class="close"></a>
		</div>
		<ul id="window_detail_endInfoCrudeOil">
			<li>
				<h3>操盘保证金</h3>
				<p></p>
			</li>
	...
	<!-- 富时A50 -->
	<div class="sif_money sif_money_div" id="accountDetailInfoCrudeOil" style="display:none;">
		<div class="fl_navtitle">
			<h3>交易账号</h3>
			<a href="javascript:void(0);" onclick="closeWindow('#accountDetailInfoCrudeOil')" class="close"></a>
		</div>
		<ul id="window_detail_accountInfoCrudeOil">
		     <table style="font-size:13px;" border="1"> 
		         ...
		         <tr>
		             <td>交易密码：</td>
		             <td><span>315975</span></td>
		         </tr>
		         <tr>
		             <td>交易软件：</td>
		             <td><a target="_blank" href="${ctx}/help?tab=software&leftMenu=8">直达快枪手</a></td>
		         </tr>
		         <tr>
		             <td>使用帮助：</td>
		             <td><a target="_blank" href="${ctx}/help?tab=rule&leftMenu=8">国际原油操盘细则</a></td>
		         </tr>
		     </table>
		</ul>
		<p class='fl_uc_userpromt' id='hismsg'><!-- 注意：从2016.03.23 18:00开始，我们的操盘软件已更换成直达快抢手快速下单软件，请新申请操盘方案的用户务必下载新软件 -->！</p>
	...
	<div class="uc">
		...
		<div class="uc_mianbar">
			<div class="uc_pay">
				<ul class="uc_paynav">
					<li data="crudeoilAll"><a href="javascript:void(0);" class="tzdr-tab" id="appStateCrudeOil" class="on">方案列表</a></li>
				</ul>
				
				<div id="appStateCrudeOilData" class="tzdr-data01" style="padding:2px; width:98%; margin:0 auto;">
				...
				<div id="appStateCrudeOilPage"></div>
				<!-- 全部申请 -->
				<div class="uc_trade">					
					<div id="content"></div>
				</div>
