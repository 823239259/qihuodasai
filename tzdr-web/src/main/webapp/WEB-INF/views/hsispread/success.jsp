...
<div class="suc_main">
    ...
    <h2><i>您已经注册成为维胜用户</i><a href="http://update.tzdr.com/Future/download/模拟盘交易软件.zip" class="suc_link1">下载行情&模拟软件</a><a href="http://www.vs.com/pay/payinfo" class="suc_link2">充值开通业务</a></h2>
