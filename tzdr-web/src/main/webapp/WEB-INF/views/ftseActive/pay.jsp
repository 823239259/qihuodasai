...
<script type="text/javascript" src="${ctx}/static/script/ftseActive/ftsePay.js?v=${v}"></script>
...
$(document).ready(function(){
	...
	$("#pay_button").on("click",function(){
		...
		$.post("${ctx}/ftseActive/isOut",{},function(data){
			if(data.success){
				if(data.message!="" && data.message!=null){
					if(data.message == "out"){
						alert("您的名额已过期，请重新申请");
						window.location.href="${ctx}/topic/ftseFreetrial";
...
<body>
	...
	<div class="capital">
		<form action="${ctx}/ftseActive/paySuccessful" id="payableForm" method="post">
