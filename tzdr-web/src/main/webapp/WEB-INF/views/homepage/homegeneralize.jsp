...
<div class="main">
    <div class="uc_sp_info">
        ...
        <div class="uc_sp_font">
            <h3>2015做什么最赚钱？</h3>            
            <p><span>维胜独创股票操盘行业无限级代理制度，成功邀请下级，即可获得超高收益分成。下级用户再邀请下级用户，所有上级用户均可获得收益分成，轻松赚大钱！<br></span><span>您可以通过朋友、QQ、微信、微博等各种方式进行推广，所有通过您的推广链接访问而来的用户，注册后都将成为您的下线用户，而当这些用户在维胜网站时，您便可以赚取所有下线用户一定比例的返点。</span> </p>
            <h3>做维胜的代理能赚多少钱？</h3>
            <p><span>成为维胜代理后，您发展的下级可再发展无限个下级，您可以获得所有下级用户的返点，收益比普通单级返点方式高出数十倍。到目前为止，维胜代理体系已向所有代理用户发放了几百万元的佣金，有几位做得比较好的代理用户，他们经过几个月的努力，现在每月佣金收入就有十几万元。</span> </p>
            <h3>佣金如何结算？</h3>
            <p><span>您的下级用户每发生一笔，在完成后您就获得一笔返点，当天的返点将在第二天凌晨0点统一为您充值到维胜网站的账户中。当您的佣金到达10元时，您就可以随时兑换并提现，当然也可以在本站进行。</span></p>
        </div>
    </div>
     <div class="uc_sp_way">
