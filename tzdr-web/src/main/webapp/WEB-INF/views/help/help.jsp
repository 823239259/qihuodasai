...
<div class="help">
    ...
    <div class="hp_ctn configuration hp_content">
        ...
        <div class="hp_mainbar  hp_mbox1">
            <h1>什么是港股操盘</h1>
            <p>港股操盘是投资达人推出的国内第一个创新型港股投资产品。用户通过少量的人民币自有资金当本金，投资达人平台提供一定倍数的港元，让投资者轻松操盘港股，实现更快捷、更丰富的投资收益。</p>
            <p>港股操盘的优势在于：</p>
            <p>1，免去繁杂的港股开户流程和手续</p>
            <p>2，免去人民币和港元的兑换手续，且无汇兑限制</p>
            <p>3，资金放大，收益翻几倍</p>
            <p>举个例子：假如您有1万元人民币本金，按实时汇率约11843港元，投资达人提供约6万港元供您操盘，涨10%赚6000港元，折合5000元人民币收益，收益全归您，投资达人只收取超低通道使用费、账户管理费和正常港股交易手续费。</p>
        </div>
        ...
        <div class="hp_mainbar hp_mbox3" style="display:none;">
            ...
            <p>二，交易账号：在工作时间内提交的操盘申请，通常会在30分钟内开通股票交易账户，其他时间下个交易日09:15前开通。交易账户开户成功后我们将短信通知您。您也可以登录投资达人 → 账户首页 → 港股方案 → 对应的操盘方案 → 操盘详情页，查询到交易账号和密码。</p>         
            ...
            <p>五，操盘天数：当您的方案到期，系统会对您的方案自动延期，最长延期时间可以在投资达人的操盘详细页里查询。方案还未到期就终止操盘，已缴纳的通道使用费不退，账户管理费从终止操盘后的次日不再扣除。</p>
			<p>六，追加保证金：当您的净资产触及到警戒线或者平仓线，需要通过投资达人追加保证金到交易账户，每次追加保证金建议追加至配资初始金额。</p>
			<p>七，方案结算：当您的港股方案申请终结后，您的操盘盈亏是港元，我们会按照该方案申请终结那天的港元汇率进行结算；港股交易是T+0，但交易到账是T+2，有2个交易日的在途股票，但投资达人为提供优质服务，我们将比港交所更快结算。工作日17:30前的终结申请，当日结算；工作日17:30后的终结申请，下个工作日17:30前结算。</p>
        </div>
        <div class="hp_mainbar hp_mbox4" style="display:none;">
            <h1>港股收费介绍</h1>
            <p>一，账户管理费：即交易账户的使用费，会在国家规定的港股交易日每天从平台余额自动扣除固定的费用。如果您在投资达人的平台余额不够扣除管理费，那么投资达人会先限制买入，两日后会按照港股操盘用户协议对交易账户强制平仓并终止方案。</p>
			<p>二，通道使用费：用户通过投资达人分发的交易账户进行港股操盘，需要缴纳给软件公司和证券公司通道使用费，由投资达人代收。通道使用费会在方案生成的时候按照客户选择的天数一次性扣除，而当方案在自动延期后，收取规则是按天（自然日）扣除，具体数额 =总通道使用费/天数。</p>
			<p>三，交易手续费：手续费包含交易佣金、印花税、交易征费、交易费和交收费，直接由交易系统扣取，投资达人平台不会再收取额外费用。手续费具体项目、收取部门及对应收费比例，详见下表：</p>
			<table width="98%" border="0" cellspacing="0" cellpadding="0" class="hp_m_list">
				<tr>
					<td>项目</td>
					<td>收费（按成交金额计算）</td>
        ...
        <div class="hp_mainbar hp_mbox6" style="display:none;">
            ...
            <p>同时因违反欠费约定，客户应及时将账户内其他股票平仓，否则投资达人有权依据协议约定将交易账户的全部股票变现为货币资金并办理客户操盘账户内资产的清算手续，并按照协议约定顺序清偿相关债务，客户所欠的债务全部清偿完毕，剩余部分返还至客户指定账户内。</p>
            <p>客户也可选择全额购回该停牌股票，购回次日起无需支付通道使用费和账户管理费。股票复牌之日起五个交易日内客户需卖出该股票并通知投资达人进行清算，按复牌实际交易日以原方案扣除账户管理费后的剩余部分返还至客户指定账户内。</p>
        </div>             
        <div class="hp_mainbar hp_mbox10" style="display:none;">
			...
			<p style="margin-left:20px;">同时因违反欠费约定，客户应及时将账户内其他股票平仓，否则投资达人有权依据协议约定将交易账户的全部股票变现为货币资金并办理客户操盘账户内资产的清算手续，并按照协议约定顺序清偿相关债务，客户所欠的债务全部清偿完毕，剩余部分返还至客户指定账户内。</p>
			<p style="margin-left:20px;">客户也可选择全额购回该进入黑名单的股票，购回次日起无需支付通道使用费和账户管理费。自该股票可交易之日起五个交易日内客户需卖出该股票并通知投资达人进行清算，按可交易的实际交易日以原方案扣除账户管理费后的剩余部分返还至客户指定账户内。</p>
        </div>  
    ...
    <div class="hp_ctn software hp_content" style="display:none;">
        ...
        <div class="hp_mainbar hp_mbox1" style="display:none;">
            ...
            <div class="hp_tts">               
                ...
                <p style="margin-bottom:40px; text-indent:0;">1，先下载并安装“<a href="http://update.tzdr.com/Future/download/.netFramework3.5.exe">.NET Framework 3.5</a>”；<br>2，再下载并安装“<a href="http://update.tzdr.com/Future/download/%E9%92%B1%E9%9A%86TTS.exe">钱隆TTS股票交易系统</a>”，然后启动程序。<br>若程序仍无法运行，请致电客服400-020-0158。</p>  
                ...
                <p style="margin-bottom:40px; text-indent:0;">1，先下载并安装“<a href="http://update.tzdr.com/Future/download/vcredist_x86.zip">VC2005运行库</a>”；<br>2，再下载并安装“<a href="http://update.tzdr.com/Future/download/%E9%92%B1%E9%9A%86TTS.exe">钱隆TTS股票交易系统</a>”，然后启动程序。<br>若程序仍无法运行，请致电客服400-020-0158。</p>            
        ...
        <div class="hp_mainbar hp_mbox8" style="display:none;">
            ...
            <div class="hp_tts">   
            	...
            	<h6 style="font-weight:bold;color:#f00; margin-bottom:10px;">若程序仍无法运行，请致电客服400-020-0158。</h6>
