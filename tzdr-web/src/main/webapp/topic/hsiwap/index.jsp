...
<head>
    ...
    <title>恒生指数“港版IF”极速交易 - 投资达人</title>
...
<div class="banner"><img src="images/wapcn/h_banner.gif"></div>
<div class="content">
    <div class="cn_ip">
        ...
        <a href="javascript:void(0);" onclick = "verifyMobile(5,'mobile')" class="space"><img src="images/wapcn/btn_01.gif"></a>
        <a href="javascript:void(0);" onclick = "verifyMobile(6,'mobile')"><img src="images/wapcn/btn_02.gif"></a> 
    </div>
    <div class="cn_pic"><img src="images/wapcn/hpic_01.gif"></div>
    <div class="cn_pic"><img src="images/wapcn/hpic_02.gif"></div>
    <div class="cn_pic"><img src="images/wapcn/hpic_03.gif"></div>
    <div class="cn_ip">
        <img src="images/wapcn/icon.gif" class="cn_ip_icon">
         <div >
        ...
        <a href="javascript:void(0);" onclick = "verifyMobile(5,'mobileA')" class="space"><img src="images/wapcn/btn_01.gif"></a>
        <a href="javascript:void(0);" onclick = "verifyMobile(6,'mobileA')"><img src="images/wapcn/btn_02.gif"></a> 
    </div>
</div>
