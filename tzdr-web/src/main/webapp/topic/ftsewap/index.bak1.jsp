...
<head>
    ...
    <title>新华富时A50 低门槛 高收益 - 投资达人</title>
...
<div class="banner"><img src="images/wapcn/banner_01.gif"></div>
<div class="content">
    <div class="cn_ip">
        ...
        <a href="javascript:void(0);" onclick = "verifyMobile(1,'mobile')" class="space"><img src="images/wapcn/btn_01.gif"></a>
        <a href="javascript:void(0);" onclick = "verifyMobile(2,'mobile')"><img src="images/wapcn/btn_02.gif"></a> 
    </div>
    <div class="cn_pic"><img src="images/wapcn/pic_01.gif"></div>
    <div class="cn_pic"><img src="images/wapcn/pic_02.gif"></div>
    <div class="cn_pic"><img src="images/wapcn/pic_03.gif"></div>
    <div class="cn_ip">
        <img src="images/wapcn/icon.gif" class="cn_ip_icon">
        <div >
        ...
        <a href="javascript:void(0);" onclick = "verifyMobile(1,'mobileA')" class="space"><img src="images/wapcn/btn_01.gif"></a>
        <a href="javascript:void(0);" onclick = "verifyMobile(2,'mobileA')"><img src="images/wapcn/btn_02.gif"></a> 
    </div>
</div>
