...
<title>新华富时A50极速开户 - 投资达人</title>
<meta content="新华富时A50,极速开户,开户零手续费,零管理费,投资达人" name="description">
...
<div class="top">
	...
	<div class="top_nav">
		<a href="http://www.tzdr.com/ftse/index" target="_blank">A50实盘申请入口</a>
		<i></i>
...
<div class="banner">
	...
	<div class="banner_login">
        ...
        <ul class="bannber_l_list">
            ...
            <li><a status="true" id="signin" name="signin" onclick="verifyMobile(1)">申请模拟开户</a></li>
         </ul>
		...
		<div class="banner_l_list2">
			...
			<a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=09b72c5eb0e3b5128aba32aba42e50c5c27d29a53928980bde8bb7b463910af7">加入喊单QQ群</a>
		</div>
	</div>
</div>
...
<div class="main m1" id="open">
	...
	<div class="mian_step">
		...
		<div class="main_steppic" style="display:none;">
			...
			<p>网银充值，及时到账；支付宝转账，5分钟内到账。<br>若您是A50新手，想试玩A50，最低充值5500元；A50高手充值没有上限</p>
		</div>
		<!-- 申请 -->
		<div class="main_steppic" style="display:none;">
			<div class="main_stpetitle"><a href="http://www.tzdr.com/ftse/index" target="_blank">进入A50操盘申请页面，申请方案</a></div>
			<img src="images/pic_03.gif">
			<p>A50新手，申请4手的方案吧；A50高手请随意选择；然后确认支付！</p>
		</div>
		<!-- 获取交易账号 -->
		<div class="main_steppic" style="display:none;">
			<div class="main_stpetitle"><a href="http://www.tzdr.com/userftse/trade_list" target="_blank">进入我的账户→富时A50，查看操盘方案里的交易账号</a></div>
...
<div class="main m2" id="soft">
	...
	<div class="step">
		...
		<a href="javascript:void(0);" date="2"><i>2</i>选择A50合约</a>
	...
	<div class="mian_step">
		...
		<div class="main_steppic" style="display:none;">
			...
			<p>找到富时A50主力合约，双击“合约名”进入合约行情图；<br>双击“买价”或“卖价”，横向下单区域会关联上该合约。</p>
		</div>
		<!-- 买入卖出 -->
		<div class="main_steppic" style="display:none;">
			<img src="images/pic_07.gif">
			<p>按图操作进行下单交易，交易时间：9:05-15:50，16:45-22:55</p>
		</div>
		<!-- 终结操盘方案 -->
		<div class="main_steppic" style="display:none;">
			<div class="main_stpetitle"><a href="http://www.tzdr.com/userftse/trade_list" target="_blank">进入我的账户→富时A50，查看操盘方案里的终结方案</a></div>
