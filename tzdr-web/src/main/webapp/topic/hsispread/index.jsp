...
<div class="top">
	...
	<div class="top_nav">
		<a href="http://www.tzdr.com/hsi/index" target="_blank">恒指期货申请入口</a>
		<i></i>
...
<div class="main m1" id="open">
	...
	<div class="mian_step">
		...
		<!-- 申请 -->
		<div class="main_steppic" style="display:none;">
			<div class="main_stpetitle"><a href="http://www.tzdr.com/hsi/index" target="_blank">进入恒指期货操盘申请页面，申请方案</a></div>
			<img src="images/pic_03.gif">
			<p>恒指期货新手，申请4手的方案吧；恒指期货高手请随意选择；然后确认支付！</p>
		</div>
		<!-- 获取交易账号 -->
		<div class="main_steppic" style="display:none;">
			<div class="main_stpetitle"><a href="http://www.tzdr.com/userhsi/trade_list" target="_blank">进入我的账户→恒指期货，查看操盘方案里的交易账号</a></div>
...
<div class="main m2" id="soft">
	...
	<div class="mian_step">
		...
		<!-- 终结操盘方案 -->
		<div class="main_steppic" style="display:none;">
			<div class="main_stpetitle"><a href="http://www.tzdr.com/userhsi/trade_list" target="_blank">进入我的账户→恒指期货，查看操盘方案里的终结方案</a></div>
