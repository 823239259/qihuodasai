...
<div class="top">
	...
	<p class="top_tel">客服热线：400-020-0158</p>
	<div class="top_nav">
		<a href="http://www.vs.com/hsi/index" target="_blank">恒指期货申请入口</a>
		<i></i>
		<a href="http://www.vs.com/signin" target="_blank">免费注册</a>
		<i></i>
		<a href="http://www.vs.com/cas/login" target="_blank">登录</a>
	</div>
</div>http://www.vs.com/ftse/index
<div class="banner">
	...
	<div class="banner_login">
		<ul class="bannber_l_list">
			...
			<li><a status="true" id="signinA" name="signinA" onclick="verifyMobile(5)">申请模拟开户</a></li>
			<li><a status="true" id="signinB" name="signinB" onclick="verifyMobile(6)">申请实盘开户</a></li>
		</ul>
...
<div class="main m1" id="open">
	...
	<div class="mian_step">
		...
		<!-- 申请 -->
		<div class="main_steppic" style="display:none;">
			<div class="main_stpetitle"><a href="http://www.vs.com/hsi/index" target="_blank">进入恒指期货操盘申请页面，申请方案</a></div>
			<img src="images/pic_03.gif">
			<p>恒指期货新手，申请4手的方案吧；恒指期货高手请随意选择；然后确认支付！</p>
		</div>
		<!-- 获取交易账号 -->
		<div class="main_steppic" style="display:none;">
			<div class="main_stpetitle"><a href="http://www.vs.com/userhsi/trade_list" target="_blank">进入我的账户→恒指期货，查看操盘方案里的交易账号</a></div>
...
<div class="main m2" id="soft">
	<div class="main_nav">
		<span>恒生指数如何实盘交易？</span>
	</div>
	<div class="step">
		<a href="javascript:void(0);" class="on" date="1"><i>1</i>登录操作软件</a>
		<a href="javascript:void(0);" date="2"><i>2</i>选择期货合约</a>
	...
	<div class="mian_step">
		...
		<div class="main_steppic" style="display:none;">
			...
			<p>找到恒指期货合约，双击“合约名”进入合约行情图<br>双击“买价”或“卖价”，横向下单区域会关联上该合约</p>
		</div>
		<!-- 买入卖出 -->
		<div class="main_steppic" style="display:none;">
			<img src="images/pic_07.gif">
			<p>按图操作进行下单交易，交易时间：9:20-11:55，13:00-16:10，17:05-22:55</p>
		</div>
		<!-- 终结操盘方案 -->
		<div class="main_steppic" style="display:none;">
			<div class="main_stpetitle"><a href="http://www.vs.com/userhsi/trade_list" target="_blank">进入我的账户→恒指期货，查看操盘方案里的终结方案</a></div>
