...
<body>
	...
	<div id="kefu">
		...
		<div class="lx"><input type="text" placeholder="您可以在这里直接与我们联系！"><span><a href="http://crm2.qq.com/page/portalpage/wpa.php?uin=4008528008&amp;aty=0&amp;a=0&amp;curl=&amp;ty=1" target="_blank" style="color: #dcefff;">发送</a></span></div>
	</div>
</body>
<script>
