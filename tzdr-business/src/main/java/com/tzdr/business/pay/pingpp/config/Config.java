...
public class Config {
	 ...
	 * 支付宝网页充值成功跳转页面
	 */
	public static String ALIPAY_PC_SUCCESS_URL = "http://hedaoqing.oicp.net/tzdr-web/user/account";
	/**
	 * 支付宝手机网站支付成功跳转页面
	 */
	public static String ALIPAY_WAP_SUCCESS_URL="http://hedaoqing.oicp.net/tzdr-app-web/tzdr/future/paysuc.html";
