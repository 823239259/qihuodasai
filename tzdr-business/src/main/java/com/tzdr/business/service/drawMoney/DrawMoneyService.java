...
/**
 * 提现service
 * <P>title:@DrawMoneyService.java</p>																								
 * <P>Description：</p>
...
public interface DrawMoneyService{
	 ...
	 * @param bankname 银行名称
	 * @param ip 登陆ip
	 * @param moneyval 获取设置的取款金额，如果取款金额大于设置的取款金额后台需要审核
	 * @param maxAuditMoney 提现审核最大值
	 *  1.将提现金额设置为1000-100000
		2.小于1000（不含）的金额由联动优势自动转账。
	 ...
	 * @param tradeNo 交易号
	 * @param date 交易完成时间
	 * @param tradestatus 状态1	WAIT_BUYER_PAY	交易创建，等待买家付款。
	 * 2TRADE_SUCCESS 交易成功，不能再次进行交易	
	   3	TRADE_CLOSED	交易关闭
