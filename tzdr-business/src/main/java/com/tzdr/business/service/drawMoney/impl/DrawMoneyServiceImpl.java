...
public class DrawMoneyServiceImpl extends BaseServiceImpl<DrawList,WithdrawalDao> implements DrawMoneyService{
	...
	/*
	 * (non-Javadoc)
	 * @see com.tzdr.business.service.DrawMoney.DrawMoneyService#getUserBankbyUserId(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.tzdr.business.service.DrawMoney.DrawMoneyService#findUsercardbycard(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.tzdr.business.service.DrawMoney.DrawMoneyService#insertDraw(com.tzdr.domain.web.entity.WUser, java.lang.String, java.lang.String, java.lang.String)
	 */
	
	@Override
	public void  insertDraw(WUser user, String money, String bankcard,
			String bankname,String ip,String orderId,String moneyval,String maxAuditMoney) {
			...
			fund.setRemark(DateUtils.dateTimeToString(new Date(), "yyyy-MM-dd HH:mm:ss")+"提现"+drawList.getMoney()+"元");
	...
	@Override
	public void insertDraw(WUser user, String money, String bankcard,
			String bankname, String ip, String orderId) {
			//人工审核数据
	 ...
	 * @see com.tzdr.business.service.drawMoney.DrawMoneyService#drawMoney(java.lang.String)
	 */
	@Override
	public JSONObject drawMoney(String drawId) {
		...
		if(drawList!=null){
			...
			try {
				...
				String dataDetail="userInfo:id:"+user.getId()+"|mobile:"+user.getMobile()+"|异常："+e.getMessage();
				EmailExceptionHandler.getInstance().HandleExceptionWithData(e, "后台调用取款接口失败", this.getClass().getName()+":moreSuccess", dataDetail);
				e.printStackTrace();
	...
	/*
	 * (non-Javadoc)
	 * @see com.tzdr.business.service.DrawMoney.DrawMoneyService#saveCard(com.tzdr.domain.web.entity.WUser, java.lang.String, java.lang.String)
	 */
	@Override
	public UserBank saveCard(WUser user, String bankname, String card,String imgpath) {
	...
	/*
	 * 提款修改(non-Javadoc)
	 * @see com.tzdr.business.service.DrawMoney.DrawMoneyService#updatDraw(java.lang.String)
	 */
	@Override
	public void updatDraw(String orderId,String aremark,String tradeNo,String tradestatus,String okdate) {
		...
		if(drawList.getStatus()!=31 && drawList.getStatus()!=4){//如果没有记录提现成功或者失败
			...
			if("4".equals(tradestatus)){
				...
				drawList.setRemark(DateUtils.dateTimeToString(new Date(), "yyyy-MM-dd HH:mm:ss")+"成功提现"+drawList.getMoney()+"元");
			   ...
			   //wuser.setAvlBal(BigDecimalUtils.add(wuser.getAvlBal(),drawList.getMoney()));//账号余额加入
				...
				fund.setPayStatus((short)1);
				fund.setRemark(DateUtils.dateTimeToString(new Date(), "yyyy-MM-dd HH:mm:ss")+"提现撤回"+drawList.getMoney()+"元。"+aremark);
				fund.setAddtime(new Date().getTime()/1000);
				fund.setUptime(new Date().getTime()/1000);
	...
	/*
	 * (non-Javadoc)
	 * @see com.tzdr.business.service.DrawMoney.DrawMoneyService#delCard(java.lang.String)
	 */
	@Override
	 ...
	 * @see com.tzdr.business.service.DrawMoney.DrawMoneyService#findDrawCount(com.tzdr.domain.web.entity.WUser)
	 */
	@Override
	...
	public void updatDraw(DrawList drawList,String tradestatus) {
		WUser wuser = drawList.getUser();   //获取用户信息
		 if("3".equals(tradestatus)){
				...
				fund.setAmount(wuser.getAvlBal());//余额
				fund.setPayStatus((short)1);
				fund.setRemark(DateUtils.dateTimeToString(new Date(), "yyyy-MM-dd HH:mm:ss")+"提现撤回"+drawList.getMoney()+"元。");
				fund.setAddtime(new Date().getTime()/1000);
				fund.setUptime(new Date().getTime()/1000);
				userFundService.save(fund);
		  }
	...
	public DrawList insertDraw(int source,WUser user, String money, String bankcard,
			PaymentSupportBank  paymentSupportBank, String ip, String orderId,
			int withdrawSetting) {
			//人工审核数据
			DrawMoneyData moneydata=drawMoneyDataService.getAduitMoneyByType("2",Double.valueOf(money));
			//线下审核数据
	...
	@Override
	public DrawList insertDraw(int source,WUser user, String money, String bankcard,
			PGBPaymentSupportBank paymentSupportBank, String ip, String orderId,
			int withdrawSetting) {
			//人工审核数据
			DrawMoneyData moneydata=drawMoneyDataService.getAduitMoneyByType("2",Double.valueOf(money));
			//线下审核数据
