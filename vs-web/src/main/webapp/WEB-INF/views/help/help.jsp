...
<div class="help">
    ...
    <div class="hp_ctn rule hp_content" style="display: none">
        ...
        <div class="hp_mainbar hp_mbox0" style="display:none;">        	
            ...
            <table border="0" cellspacing="0" cellpadding="0">
			  <tbody><tr>
			    <td width="40%;">上市交易所</td>
			    <td width="60%;">新加坡交易所（SGX）</td>
			  </tr>
			  <tr>
			  	<td>指数标的</td>
			  	<td>新华富时A50指数</td>
			  ...
			  <tr>
			  	<td>合约月份</td>
			  	<td>2个连续月，及每个年度的3月，6月，9月和12月</td>
			  </tr>
			  <tr>
			  	<td>最后交易日</td>
			  	<td>合约月份的倒数第二个交易日</td>
			  ...
			  <tr>
			  	<td>涨跌幅限制</td>
			  	<td class="sp">当价格较前一交易日结算价格上升或下跌10%时-10分钟冷却期（限于± 10%以内）之后，当价格较前一交易日的结算价上升或下跌15%--10分钟冷却期（限于± 15%以内），稍后将不再为该交易日，剩余时间设定任何价格限制，合约期满的最后交易日无价格限幅。</td>
			  </tr>
			</tbody>
			</table>
            ...
            <h2>操盘合约：</h2>
            <p>新华富时A50指数期货当期主力合约，一般指持仓量最大的合约，非主力合约在我们指定的操盘软件里无法交易。</p>  
            <h2>交易时间：</h2>
            <p>富时A50的具体交易时间段以方案申请页公示为准。</p>  
            <h2>持仓手数：</h2>
            <p>富时A50只能单向持仓，可持仓手数越多，同时下多手的几率越大，在看对方向时，盈利就成倍增大。</p>  
            <h2>操盘保证金：</h2>
            <p>出现亏损时的赔付，结束时如无亏损全额退还，保证金越多，可持仓手数越多。</p>  
            <h2>总操盘资金：</h2>
            ...
            <p>目前维胜不收取账户管理费。</p>  
            <h2>交易手续费：</h2>
            <p>每手开仓、平仓的手续费，由交易软件直接扣取。</p>  
            <h2>操盘账号：</h2>
            <p>方案申请成功后，交易日30分钟内分配操盘账号，非交易日时下个交易日开盘前15分钟分配操盘账号。</p> 
            <h2>操盘软件：</h2>
            <p>PC电脑使用易胜极星系统、维胜快手交易系统快速操盘，智能手机使用维胜APP（分ios和安卓）快速下单。</p>  
            <h2>模拟操盘：</h2>
            <p>目前富时A50模拟操盘账号有限，请致电 400-180-1860 申请。</p>  
            <h2>追加保证金：</h2>
            <p>交易日内8:00-23:30的申请，当天追加到操盘账号；23:30-次日8:00的申请，次日9:00前追加到操盘账号。</br>非交易日的申请，下个交易日9:00前追加到操盘账号。</p>  
            <h2>终结方案：</h2>
            <p>交易日内8:00-23:30的申请，当天结算到账；23:30-次日8:00的申请，次日9:00前结算到账。</br>非交易日的申请，下个交易日9:00前结算到账。</p>  
            <h2>结算汇率：</h2>
        ...
        <div class="hp_mainbar hp_mbox1 h_xsbd" style="display:none;">    
            ...
            <table border="0" cellspacing="0" cellpadding="0">
    			<tbody>
				    ...
				    <tr><td>交易手续费：恒指期货</td><td>69元/手</td></tr>
        ...
        <div class="hp_mainbar hp_mbox3" style="display:none;">    
        	<h2>第一步，手机号注册/登录</h2>
        	<p> 首先，我们得有个账号打开维胜网（www.mzkqh.com）官网，点击首页登录窗口右下角“免费注册”按钮（您也可以选择上方的另一个入口“注册”</p>
        	...
        	<p>App不用电脑，手机也能随时操盘。移动端，我们有Android（安卓）和iOS双平台应用。</br>Android：http://api.mzkqh.com/upload/vsapp.apk</br>iOS：请于App Store搜索“维胜”</p>
        	<h2>第七步，投资交易</h2>
        ...
        <div class="hp_mainbar hp_mbox8" style="display:none;">        	
            ...
            <table border="0" cellspacing="0" cellpadding="0">
    			<tbody><tr>
			    <td width="40%;">上市交易所</td>
			    <td width="60%;">纽约商业交易所（NYMEX）</td>
			  </tr>
			  <tr>
			  	<td>指数标的</td>
			  	<td>轻质低硫原油即WTI（西德克萨斯中质原油）</td>
			  </tr>
			  <tr>
			  	<td>合约月份</td>
			  	<td>12个连续月份，一季度后扩展至最长24个月，半年后至最长36个月。</td>
			  </tr>
			  <tr>
			  	<td>最后交易日</td>
			  	<td class="sp">交割月份前一个月的25日是工作日，则该日之前倒数第三个交易日是最后交易日：如果交割月份的25日不是工作日，那么25日前倒数第四个交易日是最后交易日</td>
			  </tr>
			  <tr>
			  	<td>最小波动价</td>
			  	<td>0.01个指数点（10美元）</td>
            ...
            <p>①选择方案 → ②支付保证金 → ③获取操盘账号 → ④在指定软件里操盘 → ⑤终结方案、结算到账</p>            
            <h2>操盘合约：</h2>
            <p>美国轻质原油期货当期主力合约，一般指持仓量最大的合约，非主力合约在我们指定的操盘软件里无法交易。</p>  
            <h2>交易时间：</h2>
            <p>国际原油的具体交易时间段以方案申请页公示为准。</p>  
            <h2>持仓手数：</h2>
            <p>国际原油只能单向持仓，可持仓手数越多，同时下多手的几率越大，在看对方向时，盈利就成倍增大。</p>  
            <h2>操盘保证金：</h2>
            <p>出现亏损时的赔付，结束时如无亏损全额退还，保证金越多，可持仓手数越多。</p>  
            <h2>总操盘资金：</h2>
            <p>总操盘资金=操盘保证金+平台授信额度</p>  
            ...
            <p>PC电脑使用易胜极星系统、维胜快手交易系统快速操盘，智能手机使用维胜APP（分ios和安卓）快速下单。</p>  
            <h2>模拟操盘：</h2>
            <p>目前国际原油模拟操盘账号有限，请致电 400-180-1860 申请。</p>  
            <h2>追加保证金：</h2>
            <p>交易日内8:00-23:30的申请，当天追加到操盘账号；23:30-次日8:00的申请，次日9:00前追加到操盘账号。</br>非交易日的申请，下个交易日9:00前追加到操盘账号。</p>  
            <h2>终结方案：</h2>
            <p>交易日内8:00-23:30的申请，当天结算到账；23:30-次日8:00的申请，次日9:00前结算到账。</br>非交易日的申请，下个交易日9:00前结算到账。</p>  
        ...
        <div class="hp_mainbar hp_mbox9" style="display:none;">        	
            ...
            <p>①选择方案 → ②支付保证金 → ③获取操盘账号 → ④在指定软件里操盘 → ⑤终结方案、结算到账</p>            
            <h2>操盘合约：</h2>
            <p>香港恒生指数期货当期主力合约，一般指持仓量最大的合约，非主力合约在我们指定的操盘软件里无法交易。</p>  
            <h2>交易时间：</h2>
            <p>恒指期货的具体交易时间段以方案申请页公示为准。</p>  
            <h2>持仓手数：</h2>
            <p>恒指期货只能单向持仓，可持仓手数越多，同时下多手的几率越大，在看对方向时，盈利就成倍增大。</p>  
            <h2>操盘保证金：</h2>
            <p>出现亏损时的赔付，结束时如无亏损全额退还，保证金越多，可持仓手数越多。</p>  
            <h2>总操盘资金：</h2>
            <p>总操盘资金=操盘保证金+平台授信额度</p>  
            ...
            <p>PC电脑使用易胜极星系统、维胜快手交易系统快速操盘，智能手机使用维胜APP（分ios和安卓）快速下单。</p>  
            <h2>模拟操盘：</h2>
            <p>目前恒指期货模拟操盘账号有限，请致电 400-180-1860 申请。</p>  
            <h2>追加保证金：</h2>
            <p>交易日内8:00-23:30的申请，当天追加到操盘账号；23:30-次日8:00的申请，次日9:00前追加到操盘账号。</br>非交易日的申请，下个交易日9:00前追加到操盘账号。</p>  
            <h2>终结方案：</h2>
            <p>交易日内8:00-23:30的申请，当天结算到账；23:30-次日8:00的申请，次日9:00前结算到账。</br>非交易日的申请，下个交易日9:00前结算到账。</p>  
        ...
        <div class="hp_mainbar hp_mbox7" style="display:none;">        	
			...
			<br>
            <h2 style="margin-top: 15px;">商品期货操盘流程：</h2>	
            ...
            <p>注意事项：如遇市场行情好，开户数多时可能遇到排队的情况，开户可能会有延迟。我们会按照发起时间顺序在第一时间为您开出。在等待开户时，您可以先去了解<a href="${ctx}/help?tab=software&leftMenu=1" target="_blank">鑫管家博易大师交易软件</a></p>
       		<h2>商品期货注意事项：</h2>
        ...
        <div class="hp_mainbar hp_mbox5" style="display:none;">        	   	
            ...
            <table border="0" cellspacing="0" cellpadding="0">
			  <tbody><tr>
			    <td width="12%">期货产品</td>
			    <td width="12%;">上市交易所</td>
			    <td width="23%;">交易标的</td>
			    <td width="23%">最小波动价</td>
			    <td width="26%">涨跌幅限制</td>
			  </tr>
			  <tr>
			  	<td>富时A50</td>
			  	<td>新加坡交易所</td>
			  ...
			  <tr>
			  	...
			  	<td class="sp">±0.40美元,所有合约熔断2分钟</td>
			  </tr>
			  <tr>			
			  	<td>小原油</td>
			  	<td>芝加哥交易所</td>
			  	...
			  	<td class="sp">±10美元若最近的三个合约同时出现涨跌停，所有合约熔断5分钟</td>
			  </tr>
			  <tr>
			  	<td>美白银</td>
			  	<td>芝加哥交易所</td>
            ...
            <p>①选择方案 → ②支付保证金 → ③获取操盘账号 → ④在指定软件里操盘 → ⑤终结方案、结算到账</p>            
            <h2>操盘合约：</h2>
            <p>可同时操盘17种国际期货的当期主力合约，分别为：富时A50、恒指期货、国际原油、迷你纳指、迷你道指、迷你标普、德国DAX、日经225、小恒指、美黄金、美精铜、小原油、美白银、H股指数、小H股指数、迷你德国DAX指数、天然气。</p>  
            <h2>交易时间：</h2>
            ...
            <h2>总操盘资金：</h2>
            <p>分配给您操盘账号里的美元实盘资金，由第三方公司上海禄吉提供。</p>  
            <h2>亏损平仓线：</h2>
            <p>总操盘资金低于亏损平仓线时，系统将自动平仓；低于平仓线后无法开仓，需要追加保证金到平仓线以上才可继续交易。</p>  
            <h2>账户管理费：</h2>
            <p>目前维胜不收取账户管理费。</p>  
            ...
            <p>PC电脑使用易胜极星系统、维胜快手交易系统快速操盘，智能手机使用维胜APP（分ios和安卓）快速下单。</p>  
            <h2>模拟操盘：</h2>
            <p>目前国际综合模拟操盘账号有限，请致电 400-180-1860 申请。</p>  
            <h2>追加保证金：</h2>
            <p>交易日内8:00-23:30的申请，当天追加到操盘账号；23:30-次日8:00的申请，次日9:00前追加到操盘账号。</br>非交易日的申请，下个交易日9:00前追加到操盘账号。</p>  
            <h2>终结方案：</h2>
            <p>交易日内8:00-23:30的申请，当天结算到账；23:30-次日8:00的申请，次日9:00前结算到账。</br>非交易日的申请，下个交易日9:00前结算到账。</p>  
    ...
    <div class="hp_ctn safety hp_content" style="display: none">
        ...
        <div class="hp_mainbar hp_mbox7" style="display:none;">
            ...
            <p>成都盈透科技有限公司联手重庆邮电大学电子数据保全中心，为投资者提供交易凭证保全服务。交易凭证（担保函、担保合同等信息）一旦保全，其内容、生成时间等信息将被加密固定，任何细微的修改都会 导致保全证书函数值的变化，预防遭人更改，且生成唯一的保全证书供下载。如发生司法纠纷，保全证书持有人可以通过电子数据保全中心提供的认证证书向法院或仲裁机构提供有效、可靠 的证据，从而获得举证的优势地位。</p>
    ...
    <div class="hp_ctn software hp_content" style="display:none;">
        ...
        <div class="hp_mainbar hp_mbox1" style="display:none;">
            ...
            <div class="hp_tts">    
                ...
                <p style="margin-bottom:40px; text-indent:0;"><img style="width:100%; margin-top: 20px;" alt="" src="${ctx }/static/images/help/vs-help-27.png"><a href="#"></a></p>  
        ...
        <div class="hp_mainbar hp_mbox8" style="display:none;">
            ...
            <div class="hp_tts">   
            	...
            	<h6 style="font-weight:bold;color:#fc3; margin-bottom:10px;">若程序仍无法运行，请致电客服400-180-1860。</h6>
    ...
    <div class=" hp_ctn hp_guide newbie hp_content" style="display: none">
        ...
        <div class="hp_mainbar hp_mbox1" >
        	<h2>如何注册成为维胜用户？</h2>
        	<p>第一步：打开维胜首页(www.mzkqh.com)，点击首页头部“注册”，跳转注册页面；</p>
        	<img src="${ctx}/static/images/help/vs-help-4.png" width="677" style="margin-left:30px;">
       ...
       <div class="hp_mainbar hp_mbox6" >
       		<h1>账户问题：</h1>
            <h2 class="hp_mbtitle">1、申请方案成功如何查询交易账户和密码？</h2>
            <p>申请方案成功后，维胜将通过短信进行提醒，收到短信后就可在您的维胜账户查看您的交易账号和密码，首先点击我的账户；然后找到“操盘记录”，查看交易账户和密码。</p>
            <h2 class="hp_mbtitle">2、登录交易软件提示账户密码错误怎么办？</h2>
            <p>首先请注意您密码的大小写更替，如还是不能登录可联系客服更改密码。</p>
            <h2 class="hp_mbtitle">3、注册时收不到验证码怎么办？</h2>
            <p>如果注册时未收到验证码，清理一下您的浏览器缓存即可，或者拨打客服电话400-180-1860。</p>
            <h2 class="hp_mbtitle">4、开户证件可以使用军官证、驾驶证等证件吗？</h2>
            <p>不可以。中华人民共和国居民身份证是自然人投资者参与期货市场的唯一身份证明证件。</p>
            <h2 class="hp_mbtitle">5、我的资金安全吗？</h2>
            <p>我们对客户交易资金的管理完全按照"专户专款专用"的标准模式进行运作，并且以三方监管模式——资金由银行监管，交易由券商监管，风控由维胜监管。交易委托通过易盛极星交易系统或维胜快手交易系统实时进入合作券商在市场上成交，确保交易安全、快捷。</p>
            <h2 class="hp_mbtitle">6、如何获取代金券、折扣券？</h2>
            <p>代金券和折扣券会不定期通过活动发放，建议随时关注网站最新活动。</p>
            <h1>交易问题：</h1>
			<h2 class="hp_mbtitle">1、期货配资风险高吗？</h2>
            <p>期货投资会有一定的风险的，配资也会有相应的风险，配资比例越高，您的收益比例越高，那么风险相对也会越高。您需要选择一个合适比例的配资方案来进行投资，如果触发亏损警告线的话，您需要及时补仓避免被自动平仓。</p>
            <h2 class="hp_mbtitle">2、如何能降低配资的风险？</h2>
            <p>建议您在进行配资的时候选取低杠杆倍率的配资方案，并且在购入期货的时候不要进行满仓购买，这样投资风险会相对较低。也建议您预留一定的资金作为备用金，在触发亏损警告时，能及时进行补仓操作，避免因期货市场波动造成平仓的风险。</p>
            <h2 class="hp_mbtitle">3、为什么会限制买入，如何解除？</h2>
            ...
            <h2 class="hp_mbtitle">4、为什么下单后显示是废单？</h2>
            <p>有以下原因：申报价格超过涨跌停价、已成交的委托要撤单、自然人投资者选保值下单、上海品种选市价、集合竞价期间不允许下市价单、当日申请的交易编码当天不能做交易、合约月份输错、客户没有在我公司申请交易编码、重复撤销委托单。</p>
            <h2 class="hp_mbtitle">5、被平仓后怎么办？</h2>
            <p>为了降低您的风险，当您交易账户的资产总值触及到平仓线时，系统将自动平仓；平仓后可追加保证金至补仓线之上，继续买卖，方案仍可继续。</p>	
            <h2 class="hp_mbtitle">6、为什么无法终止操盘？</h2>
            <p>当您的交易账户有持仓期货或委托单时，将无法终止操盘，请在终止操盘前将您该方案的所有期货清仓并撤销委托单，即可终止操盘。</p>
       </div>   
    </div>
</div>
<!--底部 -->
