...
<style type="text/css">
.cp_paylist2 tr td a { color:#0aaff4;}
.cp_paylist2 tr td a:hover { text-decoration:underline;}
</style>
...
<!--隐藏域--> 
	...
	<div class="cp_ctn" style="border-top:none;">
		...
		<div class="cp_payctn">	
			...
			<p class="cp_paypromt hk_paypromt">账户管理费是<i>使用一个交易日扣一次</i>，所以请保持账户余额充足；当账户余额不足时，我们将主动为您终结操盘方案。<em id="need_next_pay" style="color:#ff3000;">您的余额不足以扣取下一个交易日的管理费，请及时充值，以免方案被自动平仓、终止。</em></p>		
			<div class="cp_paytitle">风险规则</div>  
			<table class="cp_paylist2 hk_paylist2" cellpadding="0" cellspacing="0">
				<tr>
					<td width="40%">操盘须知</td>
				...
				<tr>
					<td>${operatorsInfo}<a href="${ctx}/help?tab=configuration&leftMenu=10" target="_blank">港股黑名单>></a></td>
