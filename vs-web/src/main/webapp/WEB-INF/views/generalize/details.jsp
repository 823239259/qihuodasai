			...
			<div class="uc_pay">
				...
				<%-- <div class="generalizeSubtab" id="detailDiv" style="display:">
					...
					<div class="uc_sp_way">
				        ...
				        <div class="uc_sp_wayctn"><p><span>请联系维胜的<i>客服电话400-180-1860</i>或<i>客服qq 400-180-1860</i>，选择您想获得的返点级别，完成相应的审核过程，即可在您的个人中心-代理赚钱栏目看到您的返点数额。<br></span><span>您自己股票操盘和所有下级用户股票操盘时产生的管理费*您选择的代理返点=您的佣金收入。<br></span><span>您可以给下级开设返点数，最高不超过您选择的代理返点级别。</span></p></div>
				    </div>
				    <div class="uc_sp_way">
				...
				<div class="uc_splink">
					...
					<div class="uc_spl_share content">
						<p class="uc_spl_sfont">
							牛市来了，小资金如何做大？我最近在维胜网站股票操盘炒股，收益可扩大15倍，你也可以来试试！<%-- <a href="http://www.mzkqh.com?uid=${id}">http://www.mzkqh.com?uid=${id}</a> --%>
						</p>
