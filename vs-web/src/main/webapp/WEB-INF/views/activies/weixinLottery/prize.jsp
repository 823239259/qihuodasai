...
<head>
	...
	<meta name="author" content="www.mzkqh.com" />
...
<footer>
    ...
    <a href="${ctx}/weixin/lottery/prize"><img src="${ctx}/static/images/weixinLottery/navon_02.jpg"></a>
    <a href="${ctx}/weixin/lottery/rule"><img src="${ctx}/static/images/weixinLottery/nav_03.gif"></a>
</footer>
</body>
</html>
