...
<div class="tp_box">
	...
	<div class="tp_rule">
		<ul class="tp_ru_list">
			<li><i>1</i><p>用户登录维胜网后即可参与开箱抽奖，可抽奖次数以上一交易日国际期货交易总手数为计算依据，每10次可抽一次。一个用户有多个方案（含不同品种）时，以总手数为计算依据。所以为了大奖，可以多交易哦！</p></li>
			...
			<li><i>4</i><p>当您抽中5000元现金大奖后，将由客服人员与您联系，并在3个工作日内直接充入您在维胜平台的账户余额中，可直接提现。</p></li>
			<li><i>5</i><p>当您抽中其它金额的现金红包后，3个工作日内将金额充入您在维胜平台的账户余额中，可直接提现。</p></li>
