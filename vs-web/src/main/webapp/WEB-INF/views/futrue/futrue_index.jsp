...
if (data != null) {
	List<DataMap> datas =  data.findByTypeKey("futureTranFees");
	List<DataMap> defDatas =  data.findByTypeKey("futureDefTranFees");
...
<script type="text/javascript">
    function submitSetting() {
    	if ($("#checkbox_agree").attr("checked")) {
    		if(!isLoginSSO){
    			window.location.href=basepath+"/toFutureIndexSSO"; 
    		}else{
    ...
    $(document).ready(function(){
		...
		//亏损平仓线=总操盘金-用户保证金*手数+3000*手数
		var warningLoss = 0;
		//管理费
		var manageFee = 0;
		//交易默认手续费
		var tranDefaultFees = <%=tranDefaultFees%>;
		//交易手续费
		var tranFees = <%=tranDefaultFees%>;
		//配置值【临时变量存储】
		var configTranFees = <%=tranFees%>;
    	$.easyui.rechangeSetValue(".zk_ul_futrue_traderBond li","#input_traderBond",function(){
    		traderBand = $("#input_traderBond").val() - 0;
    		tranLever = $("#input_tranLever").val() - 0;
    		warningLoss = traderTotal*tranLever - traderBand*tranLever + 3000*tranLever;
    		$("#totalTraderBond_id").html($.formatMoney(Number(traderBand*tranLever)));
    	...
    	$.easyui.rechangeSetValue(".zk_ul_futrue_tranDay li","#input_tranDay",function(){
    		traderBand = $("#input_traderBond").val() - 0;
    		tranDay = $("#input_tranDay").val() - 0;
    		if(tranDay == 1){
    			manageFee = 0;
    			tranFees = tranDefaultFees;
    		}
    		else{
    			tranFees = configTranFees;
    			if(tranDay == 2 || tranDay == 3){
    				manageFee = 200;
    			}else if(tranDay == 4 || tranDay == 5){
    				manageFee = 150;
    			}else if(tranDay == 6 || tranDay == 7){
    				manageFee = 120;
    			}else if(tranDay == 8 || tranDay == 9){
    				manageFee = 100;
    			}else if(tranDay == 10){
    				manageFee = 80;
    			}
    		}
    		totalManageFee = manageFee * tranDay;
    		$("#feeManage_id").html(manageFee);
    		$("#tranFees_id").html(tranFees);
...
<body>
	...
	<form action="${ctx}/future/pay" id="settingForm" method="post">
		<div class="capital">
			<div class="capital_ctn">
				<div class="cp_main sif_main">
					<div class="cp_m_ctn">
		                <div class="cp_m_titl sif_m_title">
		                    <i></i>
		                    <h3 class="cp_h2">选择可开仓手数<span>(可持仓的最大手数)</span></h3>
		                    <input type="text" id="input_tranLever" name="inputTranLever" value="1" readonly="readonly" style="font-size:0;">
		                </div>
		                <div class="cp_m_list sif_m_list2">
		                    <ul class="zk_ul_futrue_tranLever">
		                        <li class="on">
		                        	<input type="hidden" class="defaultVal" value="1" />
		                            <p><i>1</i>手</p>
		                        </li>
		                        <li>
		                        	<input type="hidden" class="defaultVal" value="2" />
		                            <p><i>2</i>手</p>
		                        </li>
		                        <li>
		                        ...
		                        <li>
		                        	<input type="hidden" class="defaultVal" value="4" />
		                            <p><i>4</i>手</p>
		                        </li>
		                        <li>
		            ...
		            <div class="cp_m_ctn">
		                <div class="cp_m_titl sif_m_title">
		                    <i></i>
		                    <h3 class="cp_h1">选择单手保证金<span>(操盘保证金越多，平仓风险越低)</span></h3>
		                    <input type="text" id="input_traderBond" name="inputTraderBond" value="6000"  readonly="readonly" style="font-size:0;">
		                </div>
		                <div class="cp_m_list sif_m_list">
		                    <ul class="zk_ul_futrue_traderBond">
		                        <li class="on">
		                        	<input type="hidden" class="defaultVal" value="6000" />
		                            <p><i>6,000</i>元</p>
		                            <span>操盘保证金额</span>
		                        </li>
		                        <li>
		                        	<input type="hidden" class="defaultVal" value="9000" />
		                            <p><i>9,000</i>元</p>
		                            <span>操盘保证金额</span>
		                        </li>
		                        <li>
		                        	<input type="hidden" class="defaultVal" value="12000" />
		                            <p><i>12,000</i>元</p>
		                            <span>操盘保证金额</span>
		                        </li>
		                        <li>
		                        	<input type="hidden" class="defaultVal" value="15000" />
		                            <p><i>15,000</i>元</p>
		                            <span>操盘保证金额</span>
		                        </li>
		                    </ul>
		            ...
		            <div class="cp_m_ctn">
		                <div class="cp_m_titl sif_m_title">
		                    <i></i>
		                    <h3 class="cp_h3">选择账户使用时间<span>(持仓不过夜，1-10个交易日)</span></h3>
		                    <input type="text" id="input_tranDay" name="inputTranDay" value="1" readonly="readonly"  style="font-size:0;">
		                </div>
		                <div class="cp_m_list sif_m_list2 sif_m_list3">
		                    <ul class="zk_ul_futrue_tranDay">
		                        <li class="on">
		                        	<input type="hidden" class="defaultVal" value="1" />
		                            <p><i>1</i>交易日</p>
		                        </li>
		                        ...
		                        <li>
		                        	<input type="hidden" class="defaultVal" value="6" />
		                            <p><i>6</i>交易日</p>
		                        </li>
		                        <li>
		                        	<input type="hidden" class="defaultVal" value="7" />
		                            <p><i>7</i>交易日</p>
		                        </li>
		                        <li>
		                        ...
		                        <li>
		                        	<input type="hidden" class="defaultVal" value="9" />
		                            <p><i>9</i>交易日</p>
		                        </li>
		                        <li>
				...
				<div class="cp_sider sif_sider sif_sider2">
					<h2>确认操盘规则</h2>
					<div class="cp_sdfont">
					...
					<div class="cp_sdfont">
		                <label>操盘保证金：</label>
		                <span><i id="totalTraderBond_id">6,000</i>元</span>
		            </div>
					<div class="cp_sdfont">
						<label>总操盘资金：</label> 
						<span><i id="totalTradeMoney_id">360,000</i>元</span>
					</div>
					<div class="cp_sdfont">
						<label>亏损平仓线<!-- <a href="javascript:void(0);"></a> -->：</label> 
						<span><i id="lineLoss_id">357,000</i>元</span>
					...
					<div class="cp_sdfont">
		                <label>账户管理费：</label>
		                <span><i id="feeManage_id">0</i>元/交易日，14:00前即日计费，14:00后次日计费(以操盘账户短信发送时间为准)</span>
		            </div>
					<div class="cp_sdfont">
						<label>交易手续费：</label> 
						<span><i id="tranFees_id">2</i>元/手，每手交易开仓和平仓的手续费。</span>
					</div>
					<div class="cp_sdfont">
						<label>申报费用：
				...
				<div class="cp_bom">
					...
					<div class="cp_b_link">
						<input type="checkbox" checked="checked" id="checkbox_agree"
							...
							href="${ctx}/static/futrue/agree.html" target="_blank">《期指随心乐操盘委托协议》</a></span>
					</div>
					<div class="cp_b_btn">
