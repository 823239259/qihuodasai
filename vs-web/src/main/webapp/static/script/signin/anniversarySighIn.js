$(document).ready(function(){
    ...
    $("#agreement").on("click",function(){
        ...
        if(status == null || status == "undefined"){
            ...
            $("#anniversary").attr("status",false);
            $("#anniversary").css({background:'#D3D3D3'});
        }else{
            $this.attr("checked","checked");
            $("#anniversary").attr("status",true);
            $("#anniversary").css({background:'#f97602'});
        }
    });
...
function flushLoginTicket() {
    ...
    var service = basepath+"outDisk/index";
