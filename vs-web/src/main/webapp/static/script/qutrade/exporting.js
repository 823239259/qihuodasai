    ...
    (function(f) {
        ...
        t(u.prototype, {
            ...
            getSVG: function(a) {
                ...
                q.createElementNS || (q.createElementNS = function(a, b) {
                ...
                e.destroy();
                w(b);
                m && (b = g.match(/<\/svg>(.*?$)/)) && (b = '<foreignObject x="0" y="0" width="200" height="200"><body xmlns="http://www.w3.org/1999/xhtml">' + b[1] + "</body></foreignObject>",
                    g = g.replace("</svg>", b + "</svg>"));
            ...
            contextMenu: function(a, c, e, b, g, f, l) {
                ...
                e + d.exportMenuWidth > h ? c.right = h - e - g - y + "px" : c.left = e - y + "px";
