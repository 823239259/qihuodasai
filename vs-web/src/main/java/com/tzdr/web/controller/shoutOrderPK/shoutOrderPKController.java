package com.tzdr.web.controller.shoutOrderPK;
...
import com.tzdr.web.controller.ifRedenvelope.ifredenvelopeController;
import com.tzdr.web.utils.UserSessionBean;

@Controller
@RequestMapping("/shoutOrderPK")
public class shoutOrderPKController {
	...
	public String sendEmail(ModelMap modelMap,HttpServletRequest request,HttpServletResponse response,String mobile){
		...
		if(usermobile!=null){
			EmailUtils.getInstance().sendMail("tianjing@tzdr.com", "恒指喊单PK活动","电话：【"+usermobile+"】");
		}
		return "success";
	}
}
