...
//        SecretKey secretKey = keyFactory.generateSecret(dks);
    ...
    public static String decrypt(String param) throws Exception {
    	...
    	byte[] inputData =decryptBASE64(param); 
    	return new String(decrypt(inputData, DESCoder.initKey()));
    }
    ...
    public static String  encrypt(String param) throws Exception {
    	 ...
    	 byte[] outputData = encrypt(param.getBytes(),  DESCoder.initKey());
    	 return DESCoder.encryptBASE64(outputData);
    }
    ...
    public static void main(String[] args) throws Exception {
    	System.out.println("加密："+encrypt("xxxx"));
    	
    	System.out.println("解密："+decrypt(encrypt("xxxx")));
    }
}