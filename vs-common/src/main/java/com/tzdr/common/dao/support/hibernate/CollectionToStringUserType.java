package com.tzdr.common.dao.support.hibernate;
...
public class CollectionToStringUserType implements UserType, ParameterizedType, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6117127521573275400L;
	/**
     * 默认,
     */
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner) throws HibernateException, SQLException {
        ...
        String[] values = StringUtil.split(valueStr, separator);
