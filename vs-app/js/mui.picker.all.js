...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">\
		...
		<div class="mui-dtpicker-title"><h5 data-id="title-y">年</h5><h5 data-id="title-m">月</h5><h5 data-id="title-d">日</h5><h5 data-id="title-h">时</h5><h5 data-id="title-i">分</h5><h5 data-id="title-i">秒</h5></div>\
	...
	var DtPicker = $.DtPicker = $.Class.extend({
		...
		_createSecond: function(current) {
			var self = this;
			var options = self.options;
			var ui = self.ui;
