<template>
	<div id="applydetail">
		...
		<!--可交易品种-->
		<div class="notice">
			<p class="fontwhite">可交易品种（一个账号可同时交易16种期货产品）</p>
			<p class="fontgray">
		...
		<!--提交申请-->
		<ul class="info">
			<li class="fontgray">提交申请表示阅读并同意 <span class="fontwhite"> 《富时A50操盘合作协议》 </span> </li>
			<li class="fontgray">
...
//			console.log(this.temp.contractList[0].shoushu);
		},
		activated: function() {
