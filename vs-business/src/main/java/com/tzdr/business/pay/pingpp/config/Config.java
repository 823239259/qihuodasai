...
public class Config {
	 ...
	 * 支付宝网页充值成功跳转页面
	 */
	public static String ALIPAY_PC_SUCCESS_URL = "http://www.mzkqh.com/user/account";
	/**
	 * 支付宝手机网站支付成功跳转页面
	 */
	public static String ALIPAY_WAP_SUCCESS_URL="http://www.mzkqh.com/paySucApp";
	/**
	 * 京东手机网页支付成功跳转页面
	 */
	public static String JD_WAP_SUCCESS_URL = "http://www.mzkqh.com/paySucApp";
	/**
	 * 京东手机网页支付失败跳转页面
	 */
	public static String JD_WAP_FAIL_URL = "http://www.mzkqh.com/user/account";
