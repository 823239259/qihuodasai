		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				if (submitType.equalsIgnoreCase(PromptTypes.isFutures)) {
					fristParam = "申请列表";
					twoParam = "期货方案";
					url = "http://manage.mzkqh.com/admin/internation/future/list";
					typeKey = "riskEmail";
					...
					fristParam = "支付宝充值审核";
					twoParam = "支付宝充值";
					url = "http://manage.mzkqh.com/admin/rechargeReview/list";
					typeKey = "fundEmail";
					emailTemplet = "messagePrompt";
					...
					fristParam = "网银充值";
					twoParam = "网银充值成功";
					url = "http://manage.mzkqh.com/admin/recharge/rechargeQuery";
					typeKey = "fundEmail";
					emailTemplet = "messagePrompt";
				} else if (submitType.equalsIgnoreCase(PromptTypes.isLineTransfer)) {
					fristParam = "线下转账待审核";
					twoParam = "线下转账提现";
					url = "http://manage.mzkqh.com/admin/withdrawAudit/list";
					typeKey = "fundEmail";
					emailTemplet = "messagePrompt";
