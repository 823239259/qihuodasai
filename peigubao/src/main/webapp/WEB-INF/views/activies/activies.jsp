...
<div class="main">
    ...
    <div class="banner5">
        <div class="ctn">
            <div class="step">
                 <p>活动期间，登陆配股宝网(www.tzdr.com)，进入活动页面点击“立即抢”，填写简单的调查问卷，即可参与“达人红包8800”活动（限1000个名额，先到先得，送完即止）。按照网站指引，全免费体验投资达人“实盘申请”股票操盘产品，领取8800元实盘资金供您操盘。活动结束后平仓结算，收益全归您，亏损我们承担。</p>
                <p>*活动期间您可以体验配股宝“实盘申请”独有的“提取收益”功能，将当天盈利提现。如果您不提现，则可将当天的盈利作为投资本金，继续进行股票投资，放大收益，并且在活动结束时有机会通过收益排名获得丰厚大奖<em>（中途提取的利润不计入收益排名）</em>。</p>
    ...
    <div class="detabox">
        <div class="deta">
            <ul class="detalist">
                    ...
                    <li>
                        <h4>1.     登陆VIP账号</h4>
                        <p class="date_p1">使用由配股宝提供的VIP账号登陆，方可参与活动。未获得VIP账户的用户，点击活动页面“立即抢VIP账号”，可参与VIP账号申领，数量有限，先到先得，送完即止。</p>
                    </li>
                    <li>
                        <h4>2.  申请操盘</h4>
                ...
                <ol class="fr">
                    <li>
                        <h4>4.  收益结算</h4>
                        <p class="date_p1">4月16日所有活动方案将会平仓结算，建议您于当天11:30之前平仓，未在11:30之前自行终止的活动方案，则配股宝有权在当天收市前帮助活动用户平仓、终止方案，<i>具体收益排名的核算以终止方案时的收益为准。</i></p>
                    </li>
                    <li>
                        <h4>5.  分享有奖</h4>
                        <p class="date_p2">4月16日活动结束后，您可以在个人中心查看您的收益排行情况，并可以通过分享按钮将您的成绩分享到朋友圈。将您分享的截图发送至配股宝官方微信，更有惊喜礼品等您领取。</p>
                    </li>
                    <li>
                        <h4>6.  赢取大奖</h4>
