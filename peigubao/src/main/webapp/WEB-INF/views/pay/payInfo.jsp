...
<!--顶部 -->
	...
	<div class="fl_box fl_uc_banks" id="issucessdiv"  style="display:none;">
		...
		<div class="fl_uc_main">
			<p class="fl_uc_charge">请在新打开的网上银行<br>页面完成付款<br>充值遇到问题请咨询客服 <br>400-633-9257</p>
...
<div class="uc">
	...
	<div class="uc_mianbar">
		<div class="uc_pay" id="banktab">			
			 ...
			 <!--  
				...
				<div class="subtab">
					...
					<div class="uc_olpromt">
						<h3>温馨提示：</h3>
						<p>1、为了您的资金安全，您的账户资金将由第三方银行托管；</br>2、充值前请注意您的银行卡充值限制，以免造成不便；</br>3、禁止洗钱、信用卡套现，虚假交易等行为，一经发现并确认，将终止该账户的使用；</br>4、为了您的资金安全，建议充值前进行实名认证，手机绑定、设置提现密码；</br>5、如果充值遇到任何问题，请联系客服：400-633-9257.</p>
					</div>
				</form>
			</div>
			<div class="subtab">
				<div id="alipay1" style="padding:20px 50px 50px;">
					<!-- 支付宝转账 -->
						...
						<div class="uc_banktime uc_aptime">
							...
							<p>2，如果支付宝绑定遇到任何问题，请致电客服：400-633-9257。</p>
						</div>
				</div>
				<div id="alipay2" style="padding:40px 0 0; display:none;">
					...
					<ul class="uc_apl_money">
						...
						<ol>
							<li><label>收款人账号名称：</label><span>上海禄吉股权投资基金管理有限公司</span></li>
						</ol>
					</ul>
					<%--
			...
			<div class="subtab">
					<div class="uc_bank">
						<p class="uc_b_title">您可以通过网上银行或银行柜台向配股宝转账（手续费最多一笔50元）</p>
						<ul class="uc_b_list">
							<ol class="first">
								<li class="uc_b_l_bank"><img src="${ctx}/static/images/banks/bank_04.jpg"></li>
								<li class="uc_b_l_info">
									<span>帐号：<i>3105 0161 3640 0000 0338</i></span>
									<span>户名：<i>上海禄吉股权投资基金管理有限公司</i></span>
									<span>开户行：<i>中国建设银行上海浦东分行</i></span>
								</li>
							</ol>
							<%-- <ol>
							...
							<ol>
								...
								<li class="uc_b_l_info">
									<span>帐号：<i>4455 6979 6048</i></span>
									<span>户名：<i>上海禄吉股权投资基金管理有限公司</i></span>
				...
				<ul class="uc_b_money">
					...
					<div class="uc_paybtn uc_b_btn">
						...
						<div class="uc_b_promt" style="display:block;"><i>注意事项</i></div>
						<p class="uc_b_promtfont" style="display:none;">1、转账时请增加转账零头（如100.85）</br>2、转账备注中请务必填写<i>注册手机号和注册用户名</i>，方便我们确认是您的汇款</br>3、转账成功后，<i>请拨打客服热线400-633-9257，或将回单发给QQ客服，</i>以便我们及时帮您处理</p>
						<p class="uc_b_promtfont" style="display:block; margin-bottom:20px;">转账成功后，请务必在上方填写 <i>转账银行</i>、<i>转账金额</i>、<i>转账流水号</i>，以便我们及时帮您处理</p>
						<div class="uc_paybtn" style="display:none;">
					...
					<div class="uc_banktime">
						<h3>到账时间:<i>如需马上到账或长时间未到账，可拨打客服电话：400-633-9257</i></h3>
						<p><i></i>工作日17:30前转账，在30分钟内完成充值到账</p>
						<p><i></i>工作日17:30后转账，在第二个工作日早上09:15前完成充值到账</p>
						<p><i></i>非工作日转账，在下一个工作日早上09:15前完成充值到账</p>
					</div>
			</div>
			<div class="subtab">
