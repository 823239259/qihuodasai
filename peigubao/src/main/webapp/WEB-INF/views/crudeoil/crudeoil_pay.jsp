...
<title>支付确认 - 恒生指数,投资达人-中国领先的互联网金融交易平台</title>
</head>
<body>
	<!--顶部 -->
    ...
    <div class="floatlayer" id="confirmPayDiv" style="display:none;">
		...
		<div class="fl_box fl_uc_bank">
            ...
            <div class="fl_uc_main">
                ...
                <a href="${ctx}/topic/ifRedenvelope" target="_blank" style="display:block; width:100%; height:40px; line-height:40px; font-size:14px; color:#f00; text-align: center; margin:-20px auto 15px;">无红包，不狂欢！现金红包送不停！</a>
            </div>
            <div class="fl_loginbtn">
			...
			<div class="cp_ctn">
				...
				<div class="cp_paymoney">
					...
					<input type="submit" style="display:none;" id="forPaySubmit" />
						...
						<div class="cp_btnback"><a href="${ctx}/crudeoil/index">返回修改</a></div>
					</div>
				</div>
			</div>
		</form>
