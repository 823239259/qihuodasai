...
<body>
	...
	<div class="sif_money sif_money_div" id="accountDetailInfoCrudeOil" style="display:none;">
		...
		<ul id="window_detail_accountInfoCrudeOil">
		     <table style="font-size:13px;" border="1"> 
		         ...
		         <tr>
		             <td>交易软件：</td>
		             <td><a target="_blank" href="${ctx}/help?tab=software&leftMenu=10">交易软件下载</a></td>
		         </tr>
		         <tr>
		             <td></td>
		             <td><a target="_blank" href="${ctx}/help?tab=rule&leftMenu=8">查看交易说明</a></td>
		         </tr>
		     </table>
		</ul>
	...
	<div class="uc">
		...
		<div class="uc_mianbar">
			<div class="uc_pay">
				<ul class="uc_paynav">
					<li data="crudeoilAll"><a href="javascript:void(0);" class="tzdr-tab" id="appStateCrudeOil" class="on">国际原油</a></li>
				</ul>
