...
<body>
	...
	<div class="sif_money sif_money_div" id="accountDetailInfoHSI" style="display:none;">
		...
		<ul id="window_detail_accountInfoHSI">
		     <table style="font-size:13px;" border="1">		     	 
		         ...
		         <tr>
		             <td></td>
		             <td><a target="_blank" href="${ctx}/help?tab=rule&leftMenu=9">查看交易说明</a></td>
		         </tr>
		     </table>
		</ul>
	...
	<div class="uc">
		...
		<div class="uc_mianbar">
			<div class="uc_pay">
				<ul class="uc_paynav">
					<li data="hsiAll"><a href="javascript:void(0);" class="tzdr-tab" id="appStateHSI" class="on">恒指期货</a></li>
				</ul>
