		...
		<div class="capital">		
			...
			<div class="capital_ctn">
				...
				<div class="cp_sider sif_sider">
					<h2>确认操盘规则</h2>
					<div class="cp_sdfont">
						<label>操盘须知：</label><span style="color:#ff6500; font-size:16px;">投资香港恒指期货当期主力合约（${contract}）</span>
					</div>
					<div class="cp_sdfont">
			...
			<div class="capital_rule">
		        ...
		        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cp_ru_list">
		          ...
		          <tr>
		            ...
		            <td class="font"><a href="${ctx}/help?tab=software&leftMenu=10" style="color:#3d9fe1; padding-right:20px;" target="_blank">交易软件下载</a><a href="${ctx}/help?tab=rule&leftMenu=9" target="_blank"  style="color:#3d9fe1; padding-right:20px;">查看交易说明</a></td>
		          </tr>
		        </table>
