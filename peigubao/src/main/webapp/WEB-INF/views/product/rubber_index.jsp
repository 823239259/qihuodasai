	...
	<input type="hidden" id="input_tranFees" name ="inputTranFees" value="${tranFeesArray[0]}" >
		<div class="capital">
			<div class="mc_nav">
		        ...
		        <a href="${ctx}/product/rubber_index" class="on">橡胶期货</a>
		    </div>
			<div class="capital_ctn">
				...
				<div class="cp_sider sif_sider">
					<h2>确认操盘规则</h2>
					<div class="cp_sdfont">
						<label>操盘须知：</label> <span style="color:#ff6500; font-size:16px;">投资橡胶当期主力合约（${contract}）</span>
					</div>
					<div class="cp_sdfont">
						<label>交易时间：</label> <span><i>9:05-14:55，21:05-22:55</i></span>
					</div>
					<div class="cp_sdfont">
		                <label>操盘保证金：</label>
		                <span>
				...
				<div class="cp_bom">
					...
					<div class="cp_b_btn">
						<a href="javascript:void();" onclick="submitSetting(4)">提交操盘申请</a>
					</div>
				</div>
			</div>
			<!-- 操盘须知 -->			
		    <div class="capital_rule">
		        ...
		        <h2>橡胶期货介绍</h2>
		        <p>上海期货交易所天然橡胶合约的交割等级为国产一级标准胶SCR5和进口烟片胶RSS3，其中国产一级标准胶SCR5通常也称为5号标准胶，执行国家技术监督局发布实施的天然橡胶GB/T8081～1999版本的各项品质指标。进口烟片胶RSS3执行国际橡胶品质与包装会议确定的“天然橡胶等级的品质与包装国际标准”（绿皮书）（1979年版）。橡胶期货具有费用低门槛低、高杠杆高收益、申请快期限短、易操作低风险，吸引了众多期货投资者。</p>	
		        <h2>交易细则</h2>        
		        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cp_ru_list">
		          ...
		          <tr>
		            ...
		            <td class="font">上海期货交易所橡胶主力合约，交易代码RUM</td>
		          </tr>
		          <tr>
		            <td class="first">最小波动价</td>
		            <td class="font">5个指数点（50元）</td>
		          </tr>
		          <tr>
		            <td class="first">合约乘数</td>
		            <td class="font">10元/点</td>
		          </tr>
		          <tr>
		            <td class="first">交易时间</td>
		            
		            <td class="font">9:05-14:55，21:05-22:55。不能跨时段交易。</td>
		          </tr>
		          <tr>
		          ...
		          <tr>
		            ...
		            <td class="font">看多时：交易盈亏=（卖出价-买入价）* 10<br>看空时：交易盈亏=（买入价-卖出价）* 10</td>
		          </tr>		          
		          <tr>
