...
<script type="text/javascript">
    ...
    $(document).ready(function(){
	    ...
	    $.easyui.rechangeSetValue(".tzdr-tab",null,function(tag){
	    	...
	    	var type = "";
	    	//1.期指随心乐
	    	if (id == "appStateGoldData") { //沪金
	    		type = "1";
	    		getDataList(page_index,type,
			    		tabId,"appStateGoldPage","pay");
	    ...
	    $("#appStateGold").trigger("click"); //初始化显示沪金页面
    });
   ...
   <div class="sif_money sif_money_div" id="accountDetailInfo" style="display:none;">
		...
		<ul id="window_detail_accountInfo">
		     <table style="font-size:13px;" border="1">
		         ...
		         <tr>
		             <td>交易软件：</td>
		             <td><a target="_blank" href="${ctx}/help?tab=software&leftMenu=9">交易软件下载</a>   </td>
		         </tr>		         
		         <tr>
		             <td></td>
		             <td><a target="_blank" href="${ctx}/help?tab=rule&leftMenu=7">查看交易说明</a>   </td>
		         </tr>
		     </table>
		</ul>
	</div>
	...
	<div class="uc">
		...
		<div class="uc_mianbar">
			<div class="uc_pay">
				...
				<!-- 沪金-->
				<div id="appStateGoldData" class="tzdr-data01" style="padding:2px; width:98%; margin:0 auto;">
