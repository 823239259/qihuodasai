				...
				<div class="generalizeSubtab" id="detailDiv" style="display:">
					...
					<div class="uc_sp_info">
						...
						<div class="uc_sp_font">
							<h3>什么是股票代理</h3>
							<p><span>股票代理是配股宝独创的股票操盘行业无限级代理制度，成功邀请下级操盘，即可获得超高收益分成。下级用户再邀请下级用户，所有上级用户均可获得收益分成，轻松赚大钱！<br></span><span>您可以通过朋友、QQ、微信、微博等各种方式进行推广，所有通过您的推广链接访问而来的用户，注册后都将成为您的下级用户，当这些用户在配股宝网站股票操盘时，您便可以赚取下线用户一定比例的返点。</span></p>
							<h3>为什么要做配股宝代理</h3>
		           			<p><span>客户提成上不封顶：获得代理资格后，每成功邀请一名下线用户，股票操盘产生管理费后，即可获得相应的返点，提成金额上不封顶，平台将提成自动转至您的配股宝账户余额中。<br></span><span>限下线无限收益：您不仅可以获得直接下级所产生的收益提成，还可以获得下级的下级、无限下级的所有收益提成。<br></span><span>快捷的操作流程：将您的推广链接通过各种渠道进行宣传，点击您的推广链接进入网站并注册的用户即自动成为您的下级用户。 </span></p>
						</div>

					</div>
					<div class="uc_sp_way">
				        <h3><i>如何成为代理</i><img src="${ctx}/static/images/uc/sp_03.gif"></h3>
				        <div class="uc_sp_wayctn"><p><span>请联系配股宝的<i>客服电话400-633-9257</i>或<i><a href="tencent://message/?uin=2167073552" style="color:#f00; text-decoration:underline ;">客服qq:2167073552</a></i>，选择您想获得的返点级别，完成相应的审核过程，即可在您的个人中心-股票代理栏目看到您的返点数额。<br></span><span>您自己股票操盘和所有下级用户股票操盘时产生的管理费*您选择的代理返点=您的佣金收入。<br></span><span>您可以给下级开设返点数，最高不超过您选择的代理返点级别。</span></p></div>
				    </div>
				    <div class="uc_sp_way">
				    ...
				    <div class="uc_sp_way">
		        		...
		        		<div class="uc_sp_wayctn"><p>您的下级用户每发生一笔股票操盘，在操盘完成后您就获得一笔返点，当天的返点将在第二天凌晨0点统一为您充值到配股宝网站的账户中。当您的佣金到达10元时，您就可以随时兑换并提现，当然也可以在本站进行股票操盘。</p></div>
				...
				<div class="uc_splink">
					...
					<div class="uc_spl_share content">
						...
						<div class="uc_spl_sharelist">
							<span>分享到：</span>
							<div class="bshare-custom icon-medium" style="margin-left: 11px;margin-top: inherit;" bshareUrl="<%=ConfUtil.getContext("web.address") %>/${id}" bshareTitle="股票操盘炒股，放大收益" bshareSummary="牛市来了，小资金如何做大？我最近在配股宝网站股票操盘，收益可扩大15倍，你也可以来试试！" bsharePic="<%=ConfUtil.getContext("web.address") %>/static/images/common/logo.jpg">
