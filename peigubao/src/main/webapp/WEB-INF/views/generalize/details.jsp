				...
				<div class="generalizeSubtab" id="detailDiv" style="display:">
					...
					<div class="uc_sp_info">
						...
						<div class="uc_sp_font">
							<h3>什么是代理赚钱</h3>
							<p><span>代理赚钱是配股宝独创的股票操盘行业无限级代理制度，成功邀请下级操盘，即可获得超高收益分成。下级用户再邀请下级用户，所有上级用户均可获得收益分成，轻松赚大钱！<br></span><span>您可以通过朋友、QQ、微信、微博等各种方式进行推广，所有通过您的推广链接访问而来的用户，注册后都将成为您的下级用户，当这些用户在配股宝网站股票操盘时，您便可以赚取下线用户一定比例的返点。</span></p>
							<h3>为什么要做投资达人代理</h3>
					...
					<div class="uc_sp_way">
				        ...
				        <div class="uc_sp_wayctn"><p><span>请联系配股宝的<i>客服电话400-633-9257</i>或<i>客服qq4000200158</i>，选择您想获得的返点级别，完成相应的审核过程，即可在您的个人中心-代理赚钱栏目看到您的返点数额。<br></span><span>您自己股票操盘和所有下级用户股票操盘时产生的管理费*您选择的代理返点=您的佣金收入。<br></span><span>您可以给下级开设返点数，最高不超过您选择的代理返点级别。</span></p></div>
				    </div>
				    <div class="uc_sp_way">
