	...
	var needlist=function(){
		...
		$.post(basepath + "trade/needlist.json", {}, function(result) {
			if (result.success) {
				...
				table+='</li>';
				table+='<li class="uc_tlbtn">';
				table+='	<a href="'+basepath+'trade/detail/{0}" class="uc_tlbtn_btn">操盘详情</a>';
