...
//富时A50交易明细窗口
function settingEndInfoFtse(traderBond,appendTraderBond,tranProfitLoss,parities,tranCommission,endAmount) {
            ...
            $.each(msg.pageResults,function(i,n){
            	...
            	if (type == 0) {
	            	...
	            	if(n.stateType == 2 || n.stateType == 4){
	            		html = html + "<td></td>";
	            		html = html + "<td>";
	            		html = html + "<a href='javascript:void(0);' onclick=\"openWindow('#accountDetailInfoFtse',settingAccountInfoFtse('"+ n.tranAccount + "','" + n.tranPassword +"'));\"  class='uc_tlbtn_btn_see' style='color:#34b3e0;'>查看交易账户</a>";
	            		if(n.stateType == 2){
	            			...
	            			html = html + "<a href='javascript:void(0);' data_no="+n.id+" onclick=\"showApplyEndTradeBox(0,'"+n.id+"')\" class='uc_tlbtn_btn_no' style='color:#fff;margin: 5px auto 0;'>终结方案</a>";
	            		}
	            		html = html + "</td>";
