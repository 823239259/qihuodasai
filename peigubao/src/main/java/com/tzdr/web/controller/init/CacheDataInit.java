...
public class CacheDataInit {
	...
	private void init() {
		...
		log.info("==============================CachePeiGuBaoHomePageManager homepage data Init Begin==============================");
		new CachePeiGuBaoHomePageManager(homePageCinfigDao,operationalConfigDao);
		log.info("==============================CachePeiGuBaoHomePageManager homepage data Init End==============================");
	...
	private JsonResult initBannersData() {
		...
		CachePeiGuBaoHomePageManager.refreshBannersCache();
