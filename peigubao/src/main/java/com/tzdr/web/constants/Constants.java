...
public class Constants {
	...
	public static class UserTrade {
		 ...
		 * A股最低配资金额
		 */
		public static final double  min_capital_Margin= 1500;
		
		
		/**
		 * A股最高配资金额
		 */
		public static final double max_capital_Margin = 6000000;
		 ...
		 * A股最小操盘倍数
		 */
		public static final int  MIN_LEVER= 1;
		
		
		/**
		 * A股最大操盘倍数
		 */
		public static final int MAX_LEVER = 5;
