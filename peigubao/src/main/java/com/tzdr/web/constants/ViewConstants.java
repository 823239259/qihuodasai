...
/**
 * 
 * <B>说明: </B>页面跳转路径统一管理,通用的直接写常量   带有模块性质的  写到内部类相应的模块下面
 * @zhouchen
 * 2016年1月22日 下午2:52:45
 */
public class ViewConstants {
	...
	* @date 2014年12月27日 下午3:12:58
	...
	public static class SignInViewJsp{
		...
		/**
		 * 配股宝 - 会员专享 免费赠送实盘资金【推广注册】
		 */
		public static final String GENERALIZESIGNIN_VIEW = "/views/signin/generalizesignin";
	}
	...
	* @date 2015年1月29日 上午9:20:04
	...
	public static class HelpViewJsp{
		...
		public static final String HELP_INDEX_VIEW = "/views/help/Aguknow";
		
		public static final String HELP_GANGGU_VIEW = "/views/help/Gangguknow";
		
		public static final String HELP_ANSWER_VIEW = "/views/help/answer";
		
		public static final String HELP_DOWNLOAD_VIEW = "/views/help/download";
		
		public static final String HELP_AUOUTUS_VIEW = "/views/help/auoutus";
	}
