	...
	export default{
		...
		mounted: function(){
			...
			if(this.status == 0){
				...
				this.moneyDetailList.push({title: '昨结存', val: [parseFloat(this.jCacheAccount['CNY'].OldAmount).toFixed(2)]});
				this.moneyDetailList.push({title: '今权益', val: [parseFloat(this.jCacheAccount['CNY'].TodayAmount).toFixed(2)]});
				this.moneyDetailList.push({title: '今可用', val: [parseFloat(TodayCanUse1).toFixed(2)]});
				this.moneyDetailList.push({title: '保证金', val: [parseFloat(this.jCacheAccount['CNY'].Deposit).toFixed(2)]});
				this.moneyDetailList.push({title: '冻结资金', val: [parseFloat(this.jCacheAccount['CNY'].FrozenMoney).toFixed(2)]});
				this.moneyDetailList.push({title: '逐笔浮盈', val: [parseFloat(this.jCacheAccount['CNY'].FloatingProfit).toFixed(2)]});
				this.moneyDetailList.push({title: '平仓盈亏', val: [parseFloat(this.jCacheAccount['CNY'].CloseProfit).toFixed(2)]});
				this.moneyDetailList.push({title: '入金', val: [parseFloat(this.jCacheAccount['CNY'].InMoney).toFixed(2)]});
				this.moneyDetailList.push({title: '出金', val: [parseFloat(this.jCacheAccount['CNY'].OutMoney).toFixed(2)]});
			}
		},
		activated: function(){
			//不更新画图
