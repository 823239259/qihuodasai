 ...
 * 
 */
public class CachePeiGuBaoHomePageManager {
	
	/**
	 * banner
	 */
	public static final int  BANNER_STATUS = 8;

	private static HomePageCinfigDao homePageCinfigDao;
	
	private static OperationalConfigDao operationalConfigDao;

	public static final Logger log = LoggerFactory.getLogger(CachePeiGuBaoHomePageManager.class);
	...
	public CachePeiGuBaoHomePageManager(HomePageCinfigDao dataMapDao,OperationalConfigDao operationalConfigDao) {
		synchronized (this) {
			CachePeiGuBaoHomePageManager.homePageCinfigDao = dataMapDao;
			CachePeiGuBaoHomePageManager.operationalConfigDao = operationalConfigDao;
			CachePeiGuBaoHomePageManager.init();
		}
	}
	...
	public static void refreshBannersCache(){
		...
		try {  //首页banner
			List<OperationalConfig> newBanners = operationalConfigDao.findBanner(CachePeiGuBaoHomePageManager.BANNER_STATUS);
