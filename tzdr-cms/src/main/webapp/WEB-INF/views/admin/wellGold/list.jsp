...
<%@ page language="java" import="com.tzdr.common.utils.*" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
...
<script type="text/javascript" src="${ctx}/static/script/wellGold/list.js"></script>
<link rel="stylesheet" type="text/css" href="${ctx}/static/css/dataStyle.css">
</head>
<body>
	<shiro:hasPermission name="sys:riskmanager:wellGold:view">
	<div id="wellGoldTab" class="easyui-tabs" data-options="tools:'#tab-tools',border:false,fit:true" style="margin-top: 5px;">
			<div title="待审核方案列表" data-options="tools:'#p-tools'" style="padding:20px;">
						...
						<form id="auditSearchForm" method="post">
							<table border="0" style="font-size:12px;" class="conn"  width="100%" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td>
										<input class="easyui-combobox" id="tradeAccount" name="search_EQ_feeType" data-options="
												url:'${ctx}/admin/recharge/dataMapCombobox?key=feetype&includes=2',
												valueField:'id',
												panelHeight:100,
												textField:'text'">
									</td>
					...
					<div style="margin-bottom: 5px">
						<shiro:hasPermission name="sys:riskmanager:wellGold:audit">  
				...
				<table id="edatagrid" class="easyui-datagrid"
			        ...
			        <thead>
			            <tr>
							...
							<th field="newStatusStr"  data-options="formatter:format" width="150">是否首个配资</th>
						...
						<form id="searchForm" method="post">
							<table border="0" style="font-size:12px;" class="conn"  width="100%" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td>
										<input id="startTime2" name="search_date_GTE_auditTime" class="Wdate" type="text" value="<%=nowTimeStr %>" onFocus="var endTime2=$dp.$('endTime2');WdatePicker({onpicked:function(){endTime2.focus();},maxDate:'#F{$dp.$D(\'endTime2\')}'})"/>
									      至  <input id="endTime2" name="search_date_LTE_auditTime" class="Wdate" type="text" value="<%=nowTimeStr %>" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'startTime2\')}'})"/>							      
									</td>
								</tr>
								<tr>
									...
									<td>
										<%-- <input class="easyui-combobox" id="tradeAccount" name="search_EQ_feeType" data-options="
												...
												panelHeight:100,
												textField:'text'"> --%>
										<select id="search_EQ_feeType" class="easyui-combobox" name="search_EQ_feeType" style="width:100px;height:27px;">
										    <option value="">请选择</option>
										   <!--  <option value="1">钱江版</option> -->
										    <option  value="2">钱隆TTS</option>
				...
				<table id="hasAuditData" class="easyui-datagrid"
			        ...
			        <thead>
			            <tr>
							...
							<th field="openline" width="180">亏损平仓线</th>
							<th field="feeType" width="150">账户类型</th>
	...
	<shiro:lacksPermission name="sys:riskmanager:wellGold:view">
