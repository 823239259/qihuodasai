	...
	<div id="ManageToolbar"  style="padding: 5px; height: auto">
		...
		<div style="margin-bottom: 5px">
			<shiro:hasPermission name="sys:operationalConfig:simplecoupon:create">	
			  <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="CouponManage.add()">增加</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="sys:operationalConfig:simplecoupon:update">
			 <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="CouponManage.edit()">修改</a>
			</shiro:hasPermission>
			</div>
	</div>
...
<div title="优惠券使用详情"  data-options="tools:'#p-tools'" style="padding:20px;">
	...
	<table id="edatagrid2" class="easyui-datagrid"  pagination="true" 
		            toolbar="#UseToolbar" url="${ctx}/admin/couponUse/getDatas"
		             rownumbers="true" fitColumns="true" singleSelect="true" 
		             data-options="checkOnSelect:true,toolbar:'#UseToolbar',
						frozenColumns:[[
				            {field:'ck',checkbox:true}
						]]">
			        <thead>
	...
	<div id="addWin" class="easyui-window" title="新增优惠券" 
        ...
        <table border="0" style="font-size:12px;" class="conn"  width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
              <input  name="scope" class="easyui-validatebox" data-options="required:true" type="checkbox" value="0"/>富时A50
              <input  name="scope" class="easyui-validatebox" data-options="required:true" type="checkbox" value="7"/>恒指期货
              <input  name="scope" class="easyui-validatebox" data-options="required:true" type="checkbox" value="6"/>国际原油<br/>
              <input  name="scope" class="easyui-validatebox" data-options="required:true" type="checkbox" value="8"/>国际综合
              <input  name="scope" class="easyui-validatebox" data-options="required:true" type="checkbox" value="5"/>商品期货
                </td>
                <td><span ></span></td>
            </tr> 
            <tr>
           	...
           	<tr>
                ...
                <td>
                   <input id="money2" name="money" class="easyui-validatebox"  data-options="required:true"/>
                <span id="unit"></span></td>
                <td><span></span></td>
            </tr>
             <tr>
            ...
            <td class="label right"></td>
                <td>
                   <input id="deadline2"  name="deadline" class="easyui-datetimebox"  data-options="required:true"/>
                </td>
                <td><span ></span></td>
            </tr>
            ...
            <td class="label right"></td>
                <td>
                	<input id="cycle2" name="cycle" class="easyui-validatebox"  data-options="required:true" value="0"/>
                天</td>
                <td><span ></span></td>
            </tr>
	...
	<div id="editWin" class="easyui-window" title="修改优惠券" 
        ...
        <table border="0" style="font-size:12px;" class="conn"  width="100%" cellpadding="0" cellspacing="0">
            ...
            <td class="label right"></td>
                <td>
                	<input id="cycle3" name="cycle" class="easyui-validatebox"  data-options="required:true" value="0"/>
                天</td>
                <td><span ></span></td>
            </tr>
	...
	<div id="giveWin" class="easyui-window" title="发放优惠券" 
        ...
        <table border="0" style="font-size:12px;" class="conn"  width="100%" cellpadding="0" cellspacing="0">
             <tr>
                ...
                <td>
    <input id="name4" class="easyui-combobox" name="name4" data-options="valueField:'id',textField:'text',
	                     url:'${ctx}/admin/couponUse/findName',
