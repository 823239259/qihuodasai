...
$(document).ready(function(){
	$("#edatagrid").datagrid({
		...
		collapsible:true,
		url:basepath+'admin/user/testmultilist',
		toolbar:'#tb',
		rownumbers:true,
		pagination:true,
	...
	/*	queryParams:{search_EQ_deleted:false},*/
		...
		columns:[[
		   /* {field:'id',hidden:true},*/
			...
			{field:'name',title:'电子邮箱',width:200,sortable:true},
			{field:'email',title:'手机号码',width:200,sortable:true},
			{field:'code',title:'是否管理员',width:100,sortable:true},
	...
	list:{
		doSearch:function(){
			$('#edatagrid').datagrid('load',{
				"search_LIKE_us.username" : $('#name').val(),
