...
<%
	...
	String forgetPw = "http"+"://www.mzkqh.com";//"http"+"://localhost:8088/tzdr-web/";////www.dktai.com
%>
...
<!-- <script language="javascript" src="http://www.mzkqh.com/static/script/common/jquery-1.8.0.min.js"></script> -->
<!-- start 吉鹏代码 -->
