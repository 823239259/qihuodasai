...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <script type="text/javascript" src="<%=request.getContextPath() %>/resources/jquery-ui.min.js"></script>
    ...
    --%>
    <script type="text/javascript" src="<%=request.getContextPath() %>/resources/ba-debug.min.js"></script>
